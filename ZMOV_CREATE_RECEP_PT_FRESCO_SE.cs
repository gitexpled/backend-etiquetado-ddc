...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE
    {
        public responce_ZMOV_CREATE_RECEP_PT_FRESCO_SE sapRun(request_ZMOV_CREATE_RECEP_PT_FRESCO_SE import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_PT_FRESCO_SE");
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_CARACT datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_CARACT();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEMS datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEMS();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEM_DEST row in import.LT_ITEM_DEST)
            {
                rfcTable_LT_ITEM_DEST_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEM_DEST datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEM_DEST();
            ...
            responce_ZMOV_CREATE_RECEP_PT_FRESCO_SE res = new responce_ZMOV_CREATE_RECEP_PT_FRESCO_SE();
            ...
            res.LOG = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_PT_FRESCO_SE_LOG datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LOG();
            ...
            res.LT_CARACT = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
            ...
            res.LT_ITEM_DEST = new ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEM_DEST[rfcTable_LT_ITEM_DEST.RowCount];
    ...
    public class request_ZMOV_CREATE_RECEP_PT_FRESCO_SE
    {
    ...
    public class responce_ZMOV_CREATE_RECEP_PT_FRESCO_SE
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_CARACT
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEMS
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_SE_LT_ITEM_DEST
    {
        public Int32 LFPOS;
        public String MATERIAL;
        public Decimal QUANTITY;

...
namespace rfcBaika
{
    public partial class JSON_ZMOV_STOCK_ZPL : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DB_STOCK_CONSULTA_ZPL db = new DB_STOCK_CONSULTA_ZPL();
            request_DB_CONSULTA_STOCK_ZPL cons = new request_DB_CONSULTA_STOCK_ZPL();
            cons.id = idzpl;
            cons.zpl = zpl;
            cons.stock = stock;
            ...
            responce_DB_STOCK_CONSULTA_ZPL resp = db.run(cons);

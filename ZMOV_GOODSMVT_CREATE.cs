...
namespace rfcBaika
{
    public class ZMOV_GOODSMVT_CREATE
    {
        public responce_ZMOV_GOODSMVT_CREATE sapRun(request_ZMOV_GOODSMVT_CREATE import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_GOODSMVT_CREATE");
            ...
            RfcStructureMetadata obj_ZBAPI2017_GM_HEAD_01 = SapRfcRepository.GetStructureMetadata("ZBAPI2017_GM_HEAD_01");
            IRfcStructure datos_ZBAPI2017_GM_HEAD_01 = obj_ZBAPI2017_GM_HEAD_01.CreateStructure();
            datos_ZBAPI2017_GM_HEAD_01.SetValue("PSTNG_DATE", import.HEADER.PSTNG_DATE);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("DOC_DATE", import.HEADER.DOC_DATE);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("REF_DOC_NO", import.HEADER.REF_DOC_NO);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("BILL_OF_LADING", import.HEADER.BILL_OF_LADING);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("GR_GI_SLIP_NO", import.HEADER.GR_GI_SLIP_NO);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("PR_UNAME", import.HEADER.PR_UNAME);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("HEADER_TXT", import.HEADER.HEADER_TXT);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("VER_GR_GI_SLIP", import.HEADER.VER_GR_GI_SLIP);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("VER_GR_GI_SLIPX", import.HEADER.VER_GR_GI_SLIPX);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("EXT_WMS", import.HEADER.EXT_WMS);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("REF_DOC_NO_LONG", import.HEADER.REF_DOC_NO_LONG);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("BILL_OF_LADING_LONG", import.HEADER.BILL_OF_LADING_LONG);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("BAR_CODE", import.HEADER.BAR_CODE);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("CHOFER", import.HEADER.CHOFER);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("RUT", import.HEADER.RUT);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("TRANSPORTE", import.HEADER.TRANSPORTE);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("PATENTE", import.HEADER.PATENTE);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("TELEFONO", import.HEADER.TELEFONO);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("TEXTO1", import.HEADER.TEXTO1);
            datos_ZBAPI2017_GM_HEAD_01.SetValue("SOLPED", import.HEADER.SOLPED);
            rfcFunction.SetValue("HEADER", datos_ZBAPI2017_GM_HEAD_01);
            ...
            foreach (ZMOV_GOODSMVT_CREATE_LOG row in import.LOG)
            {
                rfcTable_LOG_I.Append();
                ZMOV_GOODSMVT_CREATE_LOG datoTabla = new ZMOV_GOODSMVT_CREATE_LOG();
            ...
            foreach (ZMOV_GOODSMVT_CREATE_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_GOODSMVT_CREATE_LT_CARACT datoTabla = new ZMOV_GOODSMVT_CREATE_LT_CARACT();
            ...
            foreach (ZMOV_GOODSMVT_CREATE_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_GOODSMVT_CREATE_LT_ITEMS datoTabla = new ZMOV_GOODSMVT_CREATE_LT_ITEMS();
                ...
                rfcTable_LT_ITEMS_I.SetValue("MOVE_TYPE", row.MOVE_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("STCK_TYPE", row.STCK_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("SPEC_STOCK", row.SPEC_STOCK);
                rfcTable_LT_ITEMS_I.SetValue("VENDOR", row.VENDOR);
                rfcTable_LT_ITEMS_I.SetValue("CUSTOMER", row.CUSTOMER);
                rfcTable_LT_ITEMS_I.SetValue("SALES_ORD", row.SALES_ORD);
                rfcTable_LT_ITEMS_I.SetValue("S_ORD_ITEM", row.S_ORD_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("SCHED_LINE", row.SCHED_LINE);
                rfcTable_LT_ITEMS_I.SetValue("VAL_TYPE", row.VAL_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("ENTRY_QNT", row.ENTRY_QNT);
                rfcTable_LT_ITEMS_I.SetValue("ENTRY_UOM", row.ENTRY_UOM);
                rfcTable_LT_ITEMS_I.SetValue("ENTRY_UOM_ISO", row.ENTRY_UOM_ISO);
                rfcTable_LT_ITEMS_I.SetValue("PO_PR_QNT", row.PO_PR_QNT);
                rfcTable_LT_ITEMS_I.SetValue("ORDERPR_UN", row.ORDERPR_UN);
                rfcTable_LT_ITEMS_I.SetValue("ORDERPR_UN_ISO", row.ORDERPR_UN_ISO);
                rfcTable_LT_ITEMS_I.SetValue("PO_NUMBER", row.PO_NUMBER);
                rfcTable_LT_ITEMS_I.SetValue("PO_ITEM", row.PO_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("SHIPPING", row.SHIPPING);
                rfcTable_LT_ITEMS_I.SetValue("COMP_SHIP", row.COMP_SHIP);
                rfcTable_LT_ITEMS_I.SetValue("NO_MORE_GR", row.NO_MORE_GR);
                rfcTable_LT_ITEMS_I.SetValue("ITEM_TEXT", row.ITEM_TEXT);
                rfcTable_LT_ITEMS_I.SetValue("GR_RCPT", row.GR_RCPT);
                rfcTable_LT_ITEMS_I.SetValue("UNLOAD_PT", row.UNLOAD_PT);
                rfcTable_LT_ITEMS_I.SetValue("COSTCENTER", row.COSTCENTER);
                rfcTable_LT_ITEMS_I.SetValue("ORDERID", row.ORDERID);
                rfcTable_LT_ITEMS_I.SetValue("ORDER_ITNO", row.ORDER_ITNO);
                rfcTable_LT_ITEMS_I.SetValue("CALC_MOTIVE", row.CALC_MOTIVE);
                rfcTable_LT_ITEMS_I.SetValue("ASSET_NO", row.ASSET_NO);
                rfcTable_LT_ITEMS_I.SetValue("SUB_NUMBER", row.SUB_NUMBER);
                rfcTable_LT_ITEMS_I.SetValue("RESERV_NO", row.RESERV_NO);
                rfcTable_LT_ITEMS_I.SetValue("RES_ITEM", row.RES_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("RES_TYPE", row.RES_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("WITHDRAWN", row.WITHDRAWN);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_MAT", row.MOVE_MAT);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_PLANT", row.MOVE_PLANT);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_STLOC", row.MOVE_STLOC);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_BATCH", row.MOVE_BATCH);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_VAL_TYPE", row.MOVE_VAL_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("MVT_IND", row.MVT_IND);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_REAS", row.MOVE_REAS);
                rfcTable_LT_ITEMS_I.SetValue("RL_EST_KEY", row.RL_EST_KEY);
                rfcTable_LT_ITEMS_I.SetValue("REF_DATE", row.REF_DATE);
                rfcTable_LT_ITEMS_I.SetValue("COST_OBJ", row.COST_OBJ);
                rfcTable_LT_ITEMS_I.SetValue("PROFIT_SEGM_NO", row.PROFIT_SEGM_NO);
                rfcTable_LT_ITEMS_I.SetValue("PROFIT_CTR", row.PROFIT_CTR);
                rfcTable_LT_ITEMS_I.SetValue("WBS_ELEM", row.WBS_ELEM);
                rfcTable_LT_ITEMS_I.SetValue("NETWORK", row.NETWORK);
                rfcTable_LT_ITEMS_I.SetValue("ACTIVITY", row.ACTIVITY);
                rfcTable_LT_ITEMS_I.SetValue("PART_ACCT", row.PART_ACCT);
                rfcTable_LT_ITEMS_I.SetValue("AMOUNT_LC", row.AMOUNT_LC);
                rfcTable_LT_ITEMS_I.SetValue("AMOUNT_SV", row.AMOUNT_SV);
                rfcTable_LT_ITEMS_I.SetValue("REF_DOC_YR", row.REF_DOC_YR);
                rfcTable_LT_ITEMS_I.SetValue("REF_DOC", row.REF_DOC);
                rfcTable_LT_ITEMS_I.SetValue("REF_DOC_IT", row.REF_DOC_IT);
                rfcTable_LT_ITEMS_I.SetValue("EXPIRYDATE", row.EXPIRYDATE);
                rfcTable_LT_ITEMS_I.SetValue("PROD_DATE", row.PROD_DATE);
                rfcTable_LT_ITEMS_I.SetValue("FUND", row.FUND);
                rfcTable_LT_ITEMS_I.SetValue("FUNDS_CTR", row.FUNDS_CTR);
                rfcTable_LT_ITEMS_I.SetValue("CMMT_ITEM", row.CMMT_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("VAL_SALES_ORD", row.VAL_SALES_ORD);
                rfcTable_LT_ITEMS_I.SetValue("VAL_S_ORD_ITEM", row.VAL_S_ORD_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("VAL_WBS_ELEM", row.VAL_WBS_ELEM);
                rfcTable_LT_ITEMS_I.SetValue("GL_ACCOUNT", row.GL_ACCOUNT);
                rfcTable_LT_ITEMS_I.SetValue("IND_PROPOSE_QUANX", row.IND_PROPOSE_QUANX);
                rfcTable_LT_ITEMS_I.SetValue("XSTOB", row.XSTOB);
                rfcTable_LT_ITEMS_I.SetValue("EAN_UPC", row.EAN_UPC);
                rfcTable_LT_ITEMS_I.SetValue("DELIV_NUMB_TO_SEARCH", row.DELIV_NUMB_TO_SEARCH);
                rfcTable_LT_ITEMS_I.SetValue("DELIV_ITEM_TO_SEARCH", row.DELIV_ITEM_TO_SEARCH);
                rfcTable_LT_ITEMS_I.SetValue("SERIALNO_AUTO_NUMBERASSIGNMENT", row.SERIALNO_AUTO_NUMBERASSIGNMENT);
                rfcTable_LT_ITEMS_I.SetValue("VENDRBATCH", row.VENDRBATCH);
                rfcTable_LT_ITEMS_I.SetValue("STGE_TYPE", row.STGE_TYPE);
                rfcTable_LT_ITEMS_I.SetValue("STGE_BIN", row.STGE_BIN);
                rfcTable_LT_ITEMS_I.SetValue("SU_PL_STCK_1", row.SU_PL_STCK_1);
                rfcTable_LT_ITEMS_I.SetValue("ST_UN_QTYY_1", row.ST_UN_QTYY_1);
                rfcTable_LT_ITEMS_I.SetValue("ST_UN_QTYY_1_ISO", row.ST_UN_QTYY_1_ISO);
                rfcTable_LT_ITEMS_I.SetValue("UNITTYPE_1", row.UNITTYPE_1);
                rfcTable_LT_ITEMS_I.SetValue("SU_PL_STCK_2", row.SU_PL_STCK_2);
                rfcTable_LT_ITEMS_I.SetValue("ST_UN_QTYY_2", row.ST_UN_QTYY_2);
                rfcTable_LT_ITEMS_I.SetValue("ST_UN_QTYY_2_ISO", row.ST_UN_QTYY_2_ISO);
                rfcTable_LT_ITEMS_I.SetValue("UNITTYPE_2", row.UNITTYPE_2);
                rfcTable_LT_ITEMS_I.SetValue("STGE_TYPE_PC", row.STGE_TYPE_PC);
                rfcTable_LT_ITEMS_I.SetValue("STGE_BIN_PC", row.STGE_BIN_PC);
                rfcTable_LT_ITEMS_I.SetValue("NO_PST_CHGNT", row.NO_PST_CHGNT);
                rfcTable_LT_ITEMS_I.SetValue("GR_NUMBER", row.GR_NUMBER);
                rfcTable_LT_ITEMS_I.SetValue("STGE_TYPE_ST", row.STGE_TYPE_ST);
                rfcTable_LT_ITEMS_I.SetValue("STGE_BIN_ST", row.STGE_BIN_ST);
                rfcTable_LT_ITEMS_I.SetValue("MATDOC_TR_CANCEL", row.MATDOC_TR_CANCEL);
                rfcTable_LT_ITEMS_I.SetValue("MATITEM_TR_CANCEL", row.MATITEM_TR_CANCEL);
                rfcTable_LT_ITEMS_I.SetValue("MATYEAR_TR_CANCEL", row.MATYEAR_TR_CANCEL);
                rfcTable_LT_ITEMS_I.SetValue("NO_TRANSFER_REQ", row.NO_TRANSFER_REQ);
                rfcTable_LT_ITEMS_I.SetValue("CO_BUSPROC", row.CO_BUSPROC);
                rfcTable_LT_ITEMS_I.SetValue("ACTTYPE", row.ACTTYPE);
                rfcTable_LT_ITEMS_I.SetValue("SUPPL_VEND", row.SUPPL_VEND);
                rfcTable_LT_ITEMS_I.SetValue("MATERIAL_EXTERNAL", row.MATERIAL_EXTERNAL);
                rfcTable_LT_ITEMS_I.SetValue("MATERIAL_GUID", row.MATERIAL_GUID);
                rfcTable_LT_ITEMS_I.SetValue("MATERIAL_VERSION", row.MATERIAL_VERSION);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_MAT_EXTERNAL", row.MOVE_MAT_EXTERNAL);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_MAT_GUID", row.MOVE_MAT_GUID);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_MAT_VERSION", row.MOVE_MAT_VERSION);
                rfcTable_LT_ITEMS_I.SetValue("FUNC_AREA", row.FUNC_AREA);
                rfcTable_LT_ITEMS_I.SetValue("TR_PART_BA", row.TR_PART_BA);
                rfcTable_LT_ITEMS_I.SetValue("PAR_COMPCO", row.PAR_COMPCO);
                rfcTable_LT_ITEMS_I.SetValue("DELIV_NUMB", row.DELIV_NUMB);
                rfcTable_LT_ITEMS_I.SetValue("DELIV_ITEM", row.DELIV_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("NB_SLIPS", row.NB_SLIPS);
                rfcTable_LT_ITEMS_I.SetValue("NB_SLIPSX", row.NB_SLIPSX);
                rfcTable_LT_ITEMS_I.SetValue("GR_RCPTX", row.GR_RCPTX);
                rfcTable_LT_ITEMS_I.SetValue("UNLOAD_PTX", row.UNLOAD_PTX);
                rfcTable_LT_ITEMS_I.SetValue("SPEC_MVMT", row.SPEC_MVMT);
                rfcTable_LT_ITEMS_I.SetValue("GRANT_NBR", row.GRANT_NBR);
                rfcTable_LT_ITEMS_I.SetValue("CMMT_ITEM_LONG", row.CMMT_ITEM_LONG);
                rfcTable_LT_ITEMS_I.SetValue("FUNC_AREA_LONG", row.FUNC_AREA_LONG);
                rfcTable_LT_ITEMS_I.SetValue("LINE_ID", row.LINE_ID);
                rfcTable_LT_ITEMS_I.SetValue("PARENT_ID", row.PARENT_ID);
                rfcTable_LT_ITEMS_I.SetValue("LINE_DEPTH", row.LINE_DEPTH);
                rfcTable_LT_ITEMS_I.SetValue("QUANTITY", row.QUANTITY);
                rfcTable_LT_ITEMS_I.SetValue("BASE_UOM", row.BASE_UOM);
                rfcTable_LT_ITEMS_I.SetValue("LONGNUM", row.LONGNUM);
                rfcTable_LT_ITEMS_I.SetValue("BUDGET_PERIOD", row.BUDGET_PERIOD);
                rfcTable_LT_ITEMS_I.SetValue("EARMARKED_NUMBER", row.EARMARKED_NUMBER);
                rfcTable_LT_ITEMS_I.SetValue("EARMARKED_ITEM", row.EARMARKED_ITEM);
                rfcTable_LT_ITEMS_I.SetValue("STK_SEGMENT", row.STK_SEGMENT);
                rfcTable_LT_ITEMS_I.SetValue("MOVE_SEGMENT", row.MOVE_SEGMENT);
            }
            ...
            responce_ZMOV_GOODSMVT_CREATE res = new responce_ZMOV_GOODSMVT_CREATE();
            ...
            res.LOG = new ZMOV_GOODSMVT_CREATE_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            ...
            res.LT_CARACT = new ZMOV_GOODSMVT_CREATE_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_GOODSMVT_CREATE_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
    ...
    public class request_ZMOV_GOODSMVT_CREATE
    {
    ...
    public class responce_ZMOV_GOODSMVT_CREATE
    {
    ...
    public class ZMOV_GOODSMVT_CREATE_GOODSMVT_CODE
    {
        public String GM_CODE;
    }
    public class ZMOV_GOODSMVT_CREATE_HEADER
    {
    ...
    public class ZMOV_GOODSMVT_CREATE_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class ZMOV_GOODSMVT_CREATE_LT_CARACT
    {
    ...
    public class ZMOV_GOODSMVT_CREATE_LT_ITEMS
    {
        public String MATERIAL;
        public String PLANT;

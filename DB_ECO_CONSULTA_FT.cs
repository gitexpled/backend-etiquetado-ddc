...
namespace rfcBaika
{
    public class DB_ECO_CONSULTA_FT
    {
        public Array run(request_ECO_CONSULTA_FT datos)
        {
            List<responce_ECO_CONSULTA_FT> List = new List<responce_ECO_CONSULTA_FT>();
            ...
            sql += " where ft.id_ficha = '" + datos.CODIGO + "'";
            ...
            if (dataReader.HasRows)
            {
                ...
                {
                    responce_ECO_CONSULTA_FT res = new responce_ECO_CONSULTA_FT();
    ...
    public class responce_ECO_CONSULTA_FT
    {
        public String id;
    ...
    public class request_ECO_CONSULTA_FT
    {

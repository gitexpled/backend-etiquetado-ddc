...
namespace rfcBaika
{
    public class ZMOV_CREATE_AGRUPALOTE_KIWI
    {
        public responce_ZMOV_CREATE_AGRUPALOTE_KIWI sapRun(request_ZMOV_CREATE_AGRUPALOTE_KIWI import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_AGRUPALOTE_KIWI");
            ...
            foreach (ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS row in import.ITEMS)
            {
                rfcTable_ITEMS_I.Append();
                ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS datoTabla = new ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS();
            ...
            responce_ZMOV_CREATE_AGRUPALOTE_KIWI res = new responce_ZMOV_CREATE_AGRUPALOTE_KIWI();
            ...
            res.ITEMS = new ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS[rfcTable_ITEMS.RowCount];
            int i_ITEMS = 0;
            ...
            res.LOG = new ZMOV_CREATE_AGRUPALOTE_KIWI_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_AGRUPALOTE_KIWI_LOG datoTabla = new ZMOV_CREATE_AGRUPALOTE_KIWI_LOG();
    ...
    public class request_ZMOV_CREATE_AGRUPALOTE_KIWI
    {
        public ZMOV_CREATE_AGRUPALOTE_KIWI_HEADER HEADER;
        public ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS[] ITEMS;
    }
    public class responce_ZMOV_CREATE_AGRUPALOTE_KIWI
    {
        public String MATERIALDOCUMENT309;
        public String MATERIALDOCUMENT541;
        public ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS[] ITEMS;
        public ZMOV_CREATE_AGRUPALOTE_KIWI_LOG[] LOG;
    }
    public class ZMOV_CREATE_AGRUPALOTE_KIWI_HEADER
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_KIWI_ITEMS
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_KIWI_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

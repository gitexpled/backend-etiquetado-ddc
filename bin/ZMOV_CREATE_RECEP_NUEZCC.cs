...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_NUEZCC
    {
        public responce_ZMOV_CREATE_RECEP_NUEZCC sapRun(request_ZMOV_CREATE_RECEP_NUEZCC import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_NUEZCC");

            RfcStructureMetadata obj_ZMOV_ST_HEADER_NUEZCC = SapRfcRepository.GetStructureMetadata("ZMOV_ST_HEADER_NUEZCC");
            IRfcStructure datos_ZMOV_ST_HEADER_NUEZCC = obj_ZMOV_ST_HEADER_NUEZCC.CreateStructure();
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("BUKRS", import.HEADER.BUKRS);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("EKORG", import.HEADER.EKORG);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("EKGRP", import.HEADER.EKGRP);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("BSART", import.HEADER.BSART);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("BUDAT", import.HEADER.BUDAT);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("LIFNR", import.HEADER.LIFNR);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("XBLNR", import.HEADER.XBLNR);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("BKTXT", import.HEADER.BKTXT);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZNUEZCC_VARIEDAD", import.HEADER.ZNUEZCC_VARIEDAD);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZPRODUCTOR", import.HEADER.ZPRODUCTOR);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZEXPORTADORA", import.HEADER.ZEXPORTADORA);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZCUARTEL", import.HEADER.ZCUARTEL);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZPATENTE", import.HEADER.ZPATENTE);
            datos_ZMOV_ST_HEADER_NUEZCC.SetValue("ZCONDUCTOR", import.HEADER.ZCONDUCTOR);
            rfcFunction.SetValue("HEADER", datos_ZMOV_ST_HEADER_NUEZCC);
            IRfcTable rfcTable_ITEM_DEST_I = rfcFunction.GetTable("ITEM_DEST");
            foreach (ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST row in import.ITEM_DEST)
            {
                rfcTable_ITEM_DEST_I.Append();
                ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST datoTabla = new ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST();
            ...
            foreach (ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR row in import.ITEM_GR)
            {
                rfcTable_ITEM_GR_I.Append();
                ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR datoTabla = new ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR();
                ...
                rfcTable_ITEM_GR_I.SetValue("ZNUEZCC_CATEGORIA", row.ZNUEZCC_CATEGORIA);
                rfcTable_ITEM_GR_I.SetValue("FREE_ITEM", row.FREE_ITEM);
            }
            rfcFunction.SetValue("ITEM_GR", rfcTable_ITEM_GR_I);
            rfcFunction.Invoke(configSap);
            string aa = rfcFunction.ToString();
            responce_ZMOV_CREATE_RECEP_NUEZCC res = new responce_ZMOV_CREATE_RECEP_NUEZCC();
            ...
            res.ITEM_DEST = new ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST[rfcTable_ITEM_DEST.RowCount];
            int i_ITEM_DEST = 0;
            ...
            res.ITEM_GR = new ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR[rfcTable_ITEM_GR.RowCount];
            int i_ITEM_GR = 0;
            foreach (IRfcStructure row in rfcTable_ITEM_GR)
            {
                ...
                datoTabla.ZNUEZCC_CATEGORIA = row.GetString("ZNUEZCC_CATEGORIA");
            ...
            res.LOG = new ZMOV_CREATE_RECEP_NUEZCC_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_NUEZCC_LOG datoTabla = new ZMOV_CREATE_RECEP_NUEZCC_LOG();
    ...
    public class request_ZMOV_CREATE_RECEP_NUEZCC
    {
        public ZMOV_CREATE_RECEP_NUEZCC_HEADER HEADER;
        public ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST[] ITEM_DEST;
        public ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR[] ITEM_GR;
    }
    public class responce_ZMOV_CREATE_RECEP_NUEZCC
    {
        ...
        public ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST[] ITEM_DEST;
        public ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR[] ITEM_GR;
        public ZMOV_CREATE_RECEP_NUEZCC_LOG[] LOG;
    }
    public class ZMOV_CREATE_RECEP_NUEZCC_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
        ...
        public String XBLNR;
        public String BKTXT;
        public String ZNUEZCC_VARIEDAD;
    ...
    public class ZMOV_CREATE_RECEP_NUEZCC_ITEM_DEST
    {
        public Int32 LFPOS;
    ...
    public class ZMOV_CREATE_RECEP_NUEZCC_ITEM_GR
    {
        ...
        public String ZNUEZCC_CATEGORIA;
        public String FREE_ITEM;
    }
    public class ZMOV_CREATE_RECEP_NUEZCC_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

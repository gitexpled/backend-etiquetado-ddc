...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_NZ_PROCAL
    {
        public responce_ZMOV_CREATE_RECEP_NZ_PROCAL sapRun(request_ZMOV_CREATE_RECEP_NZ_PROCAL import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_NZ_PROCAL");
            ...
            foreach (ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL row in import.ITEM_CAL)
            {
                rfcTable_ITEM_CAL_I.Append();
                ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL datoTabla = new ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL();
                ...
                rfcTable_ITEM_CAL_I.SetValue("ZNCC_CALIBRE", row.ZNCC_CALIBRE);
                rfcTable_ITEM_CAL_I.SetValue("ZNUM_EXPORTA", row.ZNUM_EXPORTA);
                rfcTable_ITEM_CAL_I.SetValue("ZNUEZCC_VARIEDAD", row.ZNUEZCC_VARIEDAD);
            }
            rfcFunction.SetValue("ITEM_CAL", rfcTable_ITEM_CAL_I);
            rfcFunction.Invoke(configSap);
            string aa = rfcFunction.ToString();
            responce_ZMOV_CREATE_RECEP_NZ_PROCAL res = new responce_ZMOV_CREATE_RECEP_NZ_PROCAL();
            ...
            res.ITEM_CAL = new ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL[rfcTable_ITEM_CAL.RowCount];
            int i_ITEM_CAL = 0;
            foreach (IRfcStructure row in rfcTable_ITEM_CAL)
            {
                ...
                datoTabla.ZNCC_CALIBRE = row.GetString("ZNCC_CALIBRE");
                datoTabla.ZNUM_EXPORTA = row.GetString("ZNUM_EXPORTA");
                datoTabla.ZNUEZCC_VARIEDAD = row.GetString("ZNUEZCC_VARIEDAD");
                res.ITEM_CAL[i_ITEM_CAL] = datoTabla; ++i_ITEM_CAL;
            }
            IRfcTable rfcTable_LOG = rfcFunction.GetTable("LOG");
            res.LOG = new ZMOV_CREATE_RECEP_NZ_PROCAL_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_NZ_PROCAL_LOG datoTabla = new ZMOV_CREATE_RECEP_NZ_PROCAL_LOG();
    ...
    public class request_ZMOV_CREATE_RECEP_NZ_PROCAL
    {
        public ZMOV_CREATE_RECEP_NZ_PROCAL_HEADER HEADER;
        public ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL[] ITEM_CAL;
    }
    public class responce_ZMOV_CREATE_RECEP_NZ_PROCAL
    {
        public String MATERIALDOCUMENT;
        public String PEDIDO;
        public ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL[] ITEM_CAL;
        public ZMOV_CREATE_RECEP_NZ_PROCAL_LOG[] LOG;
    }
    public class ZMOV_CREATE_RECEP_NZ_PROCAL_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_NZ_PROCAL_ITEM_CAL
    {
        ...
        public String ZNCC_CALIBRE;
        public String ZNUM_EXPORTA;
        public String ZNUEZCC_VARIEDAD;
    }
    public class ZMOV_CREATE_RECEP_NZ_PROCAL_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

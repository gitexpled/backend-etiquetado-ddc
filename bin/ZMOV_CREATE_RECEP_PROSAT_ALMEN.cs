...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_PROSAT_ALMEN
    {
        public responce_ZMOV_CREATE_RECEP_PROSAT_ALMEN sapRun(request_ZMOV_CREATE_RECEP_PROSAT_ALMEN import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_PROSAT_ALMEN");
            ...
            foreach (ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL row in import.ITEM_CAL)
            {
                rfcTable_ITEM_CAL_I.Append();
                ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL datoTabla = new ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL();
                ...
                rfcTable_ITEM_CAL_I.SetValue("ZALMENDRA_CATEGORIA", row.ZALMENDRA_CATEGORIA);
            ...
            responce_ZMOV_CREATE_RECEP_PROSAT_ALMEN res = new responce_ZMOV_CREATE_RECEP_PROSAT_ALMEN();
            ...
            res.ITEM_CAL = new ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL[rfcTable_ITEM_CAL.RowCount];
            int i_ITEM_CAL = 0;
            foreach (IRfcStructure row in rfcTable_ITEM_CAL)
            {
                ...
                datoTabla.ZALMENDRA_CATEGORIA = row.GetString("ZALMENDRA_CATEGORIA");
            ...
            res.LOG = new ZMOV_CREATE_RECEP_PROSAT_ALMEN_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_PROSAT_ALMEN_LOG datoTabla = new ZMOV_CREATE_RECEP_PROSAT_ALMEN_LOG();
    ...
    public class request_ZMOV_CREATE_RECEP_PROSAT_ALMEN
    {
        public ZMOV_CREATE_RECEP_PROSAT_ALMEN_HEADER HEADER;
        public ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL[] ITEM_CAL;
    }
    public class responce_ZMOV_CREATE_RECEP_PROSAT_ALMEN
    {
        public String MATERIALDOCUMENT;
        public String PEDIDO;
        public ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL[] ITEM_CAL;
        public ZMOV_CREATE_RECEP_PROSAT_ALMEN_LOG[] LOG;
    }
    public class ZMOV_CREATE_RECEP_PROSAT_ALMEN_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_PROSAT_ALMEN_ITEM_CAL
    {
        ...
        public String ZALMENDRA_CATEGORIA;
        public String ZALMENDRA_VARIEDAD;
        public String ZNUM_EXPORTA;
    }
    public class ZMOV_CREATE_RECEP_PROSAT_ALMEN_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

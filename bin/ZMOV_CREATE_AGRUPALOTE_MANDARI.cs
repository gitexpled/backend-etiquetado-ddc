...
namespace rfcBaika
{
    public class ZMOV_CREATE_AGRUPALOTE_MANDARI
    {
        public responce_ZMOV_CREATE_AGRUPALOTE_MANDARI sapRun(request_ZMOV_CREATE_AGRUPALOTE_MANDARI import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_AGRUPALOTE_MANDARI");
            ...
            foreach (ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS row in import.ITEMS)
            {
                rfcTable_ITEMS_I.Append();
                ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS datoTabla = new ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS();
            ...
            responce_ZMOV_CREATE_AGRUPALOTE_MANDARI res = new responce_ZMOV_CREATE_AGRUPALOTE_MANDARI();
            ...
            res.ITEMS = new ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS[rfcTable_ITEMS.RowCount];
            int i_ITEMS = 0;
            ...
            res.LOG = new ZMOV_CREATE_AGRUPALOTE_MANDARI_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_AGRUPALOTE_MANDARI_LOG datoTabla = new ZMOV_CREATE_AGRUPALOTE_MANDARI_LOG();
    ...
    public class request_ZMOV_CREATE_AGRUPALOTE_MANDARI
    {
        public ZMOV_CREATE_AGRUPALOTE_MANDARI_HEADER HEADER;
        public ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS[] ITEMS;
    }
    public class responce_ZMOV_CREATE_AGRUPALOTE_MANDARI
    {
        public String MATERIALDOCUMENT309;
        public String MATERIALDOCUMENT541;
        public ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS[] ITEMS;
        public ZMOV_CREATE_AGRUPALOTE_MANDARI_LOG[] LOG;
    }
    public class ZMOV_CREATE_AGRUPALOTE_MANDARI_HEADER
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_MANDARI_ITEMS
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_MANDARI_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

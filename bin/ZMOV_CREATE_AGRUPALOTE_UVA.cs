...
namespace rfcBaika
{
    public class ZMOV_CREATE_AGRUPALOTE_UVA
    {
        public responce_ZMOV_CREATE_AGRUPALOTE_UVA sapRun(request_ZMOV_CREATE_AGRUPALOTE_UVA import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_AGRUPALOTE_UVA");
            ...
            foreach (ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS row in import.ITEMS)
            {
                rfcTable_ITEMS_I.Append();
                ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS datoTabla = new ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS();
            ...
            responce_ZMOV_CREATE_AGRUPALOTE_UVA res = new responce_ZMOV_CREATE_AGRUPALOTE_UVA();
            ...
            res.ITEMS = new ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS[rfcTable_ITEMS.RowCount];
            int i_ITEMS = 0;
            ...
            res.LOG = new ZMOV_CREATE_AGRUPALOTE_UVA_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_AGRUPALOTE_UVA_LOG datoTabla = new ZMOV_CREATE_AGRUPALOTE_UVA_LOG();
    ...
    public class request_ZMOV_CREATE_AGRUPALOTE_UVA
    {
        public ZMOV_CREATE_AGRUPALOTE_UVA_HEADER HEADER;
        public ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS[] ITEMS;
    }
    public class responce_ZMOV_CREATE_AGRUPALOTE_UVA
    {
        public String MATERIALDOCUMENT309;
        public String MATERIALDOCUMENT541;
        public ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS[] ITEMS;
        public ZMOV_CREATE_AGRUPALOTE_UVA_LOG[] LOG;
    }
    public class ZMOV_CREATE_AGRUPALOTE_UVA_HEADER
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_UVA_ITEMS
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_UVA_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_PROCAL_CIRUE
    {
        public responce_ZMOV_CREATE_RECEP_PROCAL_CIRUE sapRun(request_ZMOV_CREATE_RECEP_PROCAL_CIRUE import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_PROCAL_CIRUE");
            ...
            foreach (ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL row in import.ITEM_CAL)
            {
                rfcTable_ITEM_CAL_I.Append();
                ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL datoTabla = new ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL();
            ...
            responce_ZMOV_CREATE_RECEP_PROCAL_CIRUE res = new responce_ZMOV_CREATE_RECEP_PROCAL_CIRUE();
            ...
            res.ITEM_CAL = new ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL[rfcTable_ITEM_CAL.RowCount];
            int i_ITEM_CAL = 0;
            ...
            res.LOG = new ZMOV_CREATE_RECEP_PROCAL_CIRUE_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_PROCAL_CIRUE_LOG datoTabla = new ZMOV_CREATE_RECEP_PROCAL_CIRUE_LOG();
    ...
    public class request_ZMOV_CREATE_RECEP_PROCAL_CIRUE
    {
        public ZMOV_CREATE_RECEP_PROCAL_CIRUE_HEADER HEADER;
        public ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL[] ITEM_CAL;
    }
    public class responce_ZMOV_CREATE_RECEP_PROCAL_CIRUE
    {
        public String MATERIALDOCUMENT;
        public String PEDIDO;
        public ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL[] ITEM_CAL;
        public ZMOV_CREATE_RECEP_PROCAL_CIRUE_LOG[] LOG;
    }
    public class ZMOV_CREATE_RECEP_PROCAL_CIRUE_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_PROCAL_CIRUE_ITEM_CAL
    {
    ...
    public class ZMOV_CREATE_RECEP_PROCAL_CIRUE_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

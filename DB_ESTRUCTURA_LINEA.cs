...
namespace rfcBaika
{
    public class DB_ESTRUCTURA_LINEA
    {
        public responce_estructura run(request_estructura datos)
        {
            responce_estructura res = new responce_estructura();
            ...
            for (int i = 0; i < items.Count; i++) //loop through rows
            {
                ...
                try
                {
                    cmd = new SqlCommand("Guardado_Estructura", connection);
    ...
    public class request_estructura
    {
        public String jsn;
        public String consulta;
    }
    public class responce_estructura
    {
        public String ok;
        public String error;
    }

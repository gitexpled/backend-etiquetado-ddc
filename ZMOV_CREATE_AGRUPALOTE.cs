...
namespace rfcBaika
{
    public class ZMOV_CREATE_AGRUPALOTE
    {
        public responce_ZMOV_CREATE_AGRUPALOTE sapRun(request_ZMOV_CREATE_AGRUPALOTE import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_AGRUPALOTE");
            ...
            foreach (ZMOV_CREATE_AGRUPALOTE_ITEMS row in import.ITEMS)
            {
                rfcTable_ITEMS_I.Append();
                ZMOV_CREATE_AGRUPALOTE_ITEMS datoTabla = new ZMOV_CREATE_AGRUPALOTE_ITEMS();
                ...
                rfcTable_ITEMS_I.SetValue("MOVE_SEGMENT", row.MOVE_SEGMENT);*/
            }
            rfcFunction.SetValue("ITEMS", rfcTable_ITEMS_I);
            rfcFunction.Invoke(configSap);
            string aa = rfcFunction.ToString();
            responce_ZMOV_CREATE_AGRUPALOTE res = new responce_ZMOV_CREATE_AGRUPALOTE();
            ...
            res.ITEMS = new ZMOV_CREATE_AGRUPALOTE_ITEMS[rfcTable_ITEMS.RowCount];
            int i_ITEMS = 0;
            ...
            res.LOG = new ZMOV_CREATE_AGRUPALOTE_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_AGRUPALOTE_LOG datoTabla = new ZMOV_CREATE_AGRUPALOTE_LOG();
    ...
    public class request_ZMOV_CREATE_AGRUPALOTE
    {
        public ZMOV_CREATE_AGRUPALOTE_HEADER HEADER;
        public ZMOV_CREATE_AGRUPALOTE_ITEMS[] ITEMS;
    }
    public class responce_ZMOV_CREATE_AGRUPALOTE
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_HEADER
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_ITEMS
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

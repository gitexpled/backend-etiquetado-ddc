...
namespace rfcBaika
{
    public partial class ECO_INFORME_CAJA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            DB_ECO_INFORME_CAJA db = new DB_ECO_INFORME_CAJA();
            request_ECO_INFORME_CAJA req = new request_ECO_INFORME_CAJA();

...
namespace rfcBaika
{
    public class ZMOV_UPDATE_HU_HEADER_N_APR
    {
        public responce_ZMOV_UPDATE_HU_HEADER_N_APR sapRun(request_ZMOV_UPDATE_HU_HEADER_N_APR import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_UPDATE_HU_HEADER_N_APR");
            ...
            foreach (ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU row in import.IT_HU)
            {
                rfcTable_IT_HU_I.Append();
                ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU datoTabla = new ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU();
                rfcTable_IT_HU_I.SetValue("HU_EXID", row.HU_EXID);
            }
            rfcFunction.SetValue("IT_HU", rfcTable_IT_HU_I);
            rfcFunction.Invoke(configSap);
            string aa = rfcFunction.ToString();
            responce_ZMOV_UPDATE_HU_HEADER_N_APR res = new responce_ZMOV_UPDATE_HU_HEADER_N_APR();
            IRfcTable rfcTable_IT_HU = rfcFunction.GetTable("IT_HU");
            res.IT_HU = new ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU[rfcTable_IT_HU.RowCount];
            int i_IT_HU = 0;
            ...
            res.RETURN = new ZMOV_UPDATE_HU_HEADER_N_APR_RETURN[rfcTable_RETURN.RowCount];
            int i_RETURN = 0;
            foreach (IRfcStructure row in rfcTable_RETURN)
            {
                ZMOV_UPDATE_HU_HEADER_N_APR_RETURN datoTabla = new ZMOV_UPDATE_HU_HEADER_N_APR_RETURN();
    ...
    public class request_ZMOV_UPDATE_HU_HEADER_N_APR
    {
    ...
    public class responce_ZMOV_UPDATE_HU_HEADER_N_APR
    {
        public ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU[] IT_HU;
        public ZMOV_UPDATE_HU_HEADER_N_APR_RETURN[] RETURN;
    }
    public class ZMOV_UPDATE_HU_HEADER_N_APR_HUCHANGED
    {
    ...
    public class ZMOV_UPDATE_HU_HEADER_N_APR_IS_PAISES
    {
    ...
    public class ZMOV_UPDATE_HU_HEADER_N_APR_IT_HU
    {
        public String HU_EXID;
    }
    public class ZMOV_UPDATE_HU_HEADER_N_APR_RETURN
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

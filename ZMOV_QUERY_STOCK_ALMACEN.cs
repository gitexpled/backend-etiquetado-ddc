...
namespace rfcBaika
{
    public class ZMOV_QUERY_STOCK_ALMACEN
    {
        public responce_ZMOV_QUERY_STOCK_ALMACEN sapRun(request_ZMOV_QUERY_STOCK_ALMACEN import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_QUERY_STOCK_ALMACEN");

            IRfcTable rfcTable_MATNR_I = rfcFunction.GetTable("MATNR");
            foreach (ZMOV_QUERY_STOCK_ALMACEN_MATNR row in import.MATNR)
            {
                rfcTable_MATNR_I.Append();
                ZMOV_QUERY_STOCK_ALMACEN_MATNR datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_MATNR();
            ...
            {
                foreach (ZMOV_QUERY_STOCK_ALMACEN_LIFNR row in import.LIFNR)
                {
                    rfcTable_LIFNR.Append();
                    ZMOV_QUERY_STOCK_ALMACEN_LIFNR datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_LIFNR();
            ...
            foreach (ZMOV_QUERY_STOCK_ALMACEN_FABRICACION row in import.FABRICACION)
            {
                rfcTable_FABRICACION.Append();
                ZMOV_QUERY_STOCK_ALMACEN_FABRICACION datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_FABRICACION();
            ...
            {
            foreach (ZMOV_QUERY_STOCK_ALMACEN_LGORT row in import.LGORT)
            {
                rfcTable_LGORT_I.Append();
                ZMOV_QUERY_STOCK_ALMACEN_LGORT datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_LGORT();
            ...
            foreach (ZMOV_QUERY_STOCK_ALMACEN_WERKS row in import.WERKS)
            {
                rfcTable_WERKS_I.Append();
                ZMOV_QUERY_STOCK_ALMACEN_WERKS datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_WERKS();
            ...
            responce_ZMOV_QUERY_STOCK_ALMACEN res = new responce_ZMOV_QUERY_STOCK_ALMACEN();
            IRfcTable rfcTable_LGORT = rfcFunction.GetTable("LGORT");
            res.LGORT = new ZMOV_QUERY_STOCK_ALMACEN_LGORT[rfcTable_LGORT.RowCount];
            int i_LGORT = 0;
            ...
            res.WERKS = new ZMOV_QUERY_STOCK_ALMACEN_WERKS[rfcTable_WERKS.RowCount];
            int i_WERKS = 0;
            ...
            res.STOCKLOTES = new ZMOV_QUERY_STOCK_ALMACEN_STOCKLOTES[rfcTable_STOCKLOTES.RowCount];
            int i_STOCKLOTES = 0;
            foreach (IRfcStructure row in rfcTable_STOCKLOTES)
            {
                ZMOV_QUERY_STOCK_ALMACEN_STOCKLOTES datoTabla = new ZMOV_QUERY_STOCK_ALMACEN_STOCKLOTES();
    ...
    public class request_ZMOV_QUERY_STOCK_ALMACEN
    {
        //public String LGORT;
        public ZMOV_QUERY_STOCK_ALMACEN_LGORT[] LGORT;
        public ZMOV_QUERY_STOCK_ALMACEN_WERKS[] WERKS;
        public ZMOV_QUERY_STOCK_ALMACEN_FABRICACION[] FABRICACION;
        public ZMOV_QUERY_STOCK_ALMACEN_LIFNR[] LIFNR;
        public ZMOV_QUERY_STOCK_ALMACEN_MATNR[] MATNR;
    }
    public class responce_ZMOV_QUERY_STOCK_ALMACEN
    {
        public ZMOV_QUERY_STOCK_ALMACEN_FABRICACION[] FABRICACION;
        public ZMOV_QUERY_STOCK_ALMACEN_LIFNR[] LIFNR;
        public ZMOV_QUERY_STOCK_ALMACEN_MATNR[] MATNR;
        public ZMOV_QUERY_STOCK_ALMACEN_LGORT[] LGORT;
        public ZMOV_QUERY_STOCK_ALMACEN_WERKS[] WERKS;
        public ZMOV_QUERY_STOCK_ALMACEN_STOCKLOTES[] STOCKLOTES;
    }
    public class ZMOV_QUERY_STOCK_ALMACEN_MATNR
    {
        public String SIGN;
    ...
    public class ZMOV_QUERY_STOCK_ALMACEN_FABRICACION
    {
        public String SIGN;
        public String OPTION;
        public String LOW;
    ...
    public class ZMOV_QUERY_STOCK_ALMACEN_LIFNR
    {
        public String SIGN;
        public String OPTION;
        public String LOW;
    ...
    public class ZMOV_QUERY_STOCK_ALMACEN_LGORT
    {
        public String SIGN;
        public String OPTION;
    ...
    public class ZMOV_QUERY_STOCK_ALMACEN_WERKS
    {
        public String SIGN;
        public String OPTION;
        public String LOW;
    ...
    public class ZMOV_QUERY_STOCK_ALMACEN_STOCKLOTES
    {
        public String MATNR;
        public String MAKTX;
        public String WERKS;

...
namespace rfcBaika
{
    public partial class ECO_CONSULTA_CALIBRE : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DB_ECO_CONSULTA_CALIBRE db = new DB_ECO_CONSULTA_CALIBRE();
            request_ECO_CONSULTA_CALIBRE req = new request_ECO_CONSULTA_CALIBRE();
            req.CENTRO = centro;

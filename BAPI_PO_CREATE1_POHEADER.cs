...
namespace rfcBaika
{
    ...
    {
        public responce_BAPI_PO_CREATE1 sapRun(request_BAPI_PO_CREATE1 import, RfcDestination configSap = null, RfcRepository SapRfcRepository = null)
        {
            ...
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("BAPI_PO_CREATE1");
            ...
            /*if (configSap == null)
            {
                ...
                if (import.USER != "" && import.USER != null)
                {
                    ...
                    rfcFunction = SapRfcRepository.CreateFunction("BAPI_PO_CREATE1");
                    configSap = destFinal;
                }
                else
                {
            ...
            IRfcTable rfcTable_POACCOUNT_I = rfcFunction.GetTable("POACCOUNT");
            foreach (BAPI_PO_CREATE1_POACCOUNT row in import.POACCOUNT)
            {
                rfcTable_POACCOUNT_I.Append();
                BAPI_PO_CREATE1_POACCOUNT datoTabla = new BAPI_PO_CREATE1_POACCOUNT();
                rfcTable_POACCOUNT_I.SetValue("PO_ITEM", row.PO_ITEM);
                rfcTable_POACCOUNT_I.SetValue("SERIAL_NO", row.SERIAL_NO);
                rfcTable_POACCOUNT_I.SetValue("DELETE_IND", row.DELETE_IND);
                rfcTable_POACCOUNT_I.SetValue("CREAT_DATE", row.CREAT_DATE);
                rfcTable_POACCOUNT_I.SetValue("QUANTITY", Math.Round(row.QUANTITY, 2));
                rfcTable_POACCOUNT_I.SetValue("DISTR_PERC", row.DISTR_PERC);
                rfcTable_POACCOUNT_I.SetValue("NET_VALUE", row.NET_VALUE);
                rfcTable_POACCOUNT_I.SetValue("GL_ACCOUNT", row.GL_ACCOUNT);
                rfcTable_POACCOUNT_I.SetValue("BUS_AREA", row.BUS_AREA);
                rfcTable_POACCOUNT_I.SetValue("COSTCENTER", row.COSTCENTER);
                rfcTable_POACCOUNT_I.SetValue("SD_DOC", row.SD_DOC);
                rfcTable_POACCOUNT_I.SetValue("ITM_NUMBER", row.ITM_NUMBER);
                rfcTable_POACCOUNT_I.SetValue("SCHED_LINE", row.SCHED_LINE);
                rfcTable_POACCOUNT_I.SetValue("ASSET_NO", row.ASSET_NO);
                rfcTable_POACCOUNT_I.SetValue("SUB_NUMBER", row.SUB_NUMBER);
                rfcTable_POACCOUNT_I.SetValue("ORDERID", row.ORDERID);
                rfcTable_POACCOUNT_I.SetValue("GR_RCPT", row.GR_RCPT);
                rfcTable_POACCOUNT_I.SetValue("UNLOAD_PT", row.UNLOAD_PT);
                rfcTable_POACCOUNT_I.SetValue("CO_AREA", row.CO_AREA);
                rfcTable_POACCOUNT_I.SetValue("COSTOBJECT", row.COSTOBJECT);
                rfcTable_POACCOUNT_I.SetValue("PROFIT_CTR", row.PROFIT_CTR);
                rfcTable_POACCOUNT_I.SetValue("WBS_ELEMENT", row.WBS_ELEMENT);
                rfcTable_POACCOUNT_I.SetValue("NETWORK", row.NETWORK);
                rfcTable_POACCOUNT_I.SetValue("RL_EST_KEY", row.RL_EST_KEY);
                rfcTable_POACCOUNT_I.SetValue("PART_ACCT", row.PART_ACCT);
                rfcTable_POACCOUNT_I.SetValue("CMMT_ITEM", row.CMMT_ITEM);
                rfcTable_POACCOUNT_I.SetValue("REC_IND", row.REC_IND);
                rfcTable_POACCOUNT_I.SetValue("FUNDS_CTR", row.FUNDS_CTR);
                rfcTable_POACCOUNT_I.SetValue("FUND", row.FUND);
                rfcTable_POACCOUNT_I.SetValue("FUNC_AREA", row.FUNC_AREA);
                rfcTable_POACCOUNT_I.SetValue("REF_DATE", row.REF_DATE);
                rfcTable_POACCOUNT_I.SetValue("TAX_CODE", row.TAX_CODE);
                rfcTable_POACCOUNT_I.SetValue("TAXJURCODE", row.TAXJURCODE);
                rfcTable_POACCOUNT_I.SetValue("NOND_ITAX", row.NOND_ITAX);
                rfcTable_POACCOUNT_I.SetValue("ACTTYPE", row.ACTTYPE);
                rfcTable_POACCOUNT_I.SetValue("CO_BUSPROC", row.CO_BUSPROC);
                rfcTable_POACCOUNT_I.SetValue("RES_DOC", row.RES_DOC);
                rfcTable_POACCOUNT_I.SetValue("RES_ITEM", row.RES_ITEM);
                rfcTable_POACCOUNT_I.SetValue("ACTIVITY", row.ACTIVITY);
                rfcTable_POACCOUNT_I.SetValue("GRANT_NBR", row.GRANT_NBR);
                rfcTable_POACCOUNT_I.SetValue("CMMT_ITEM_LONG", row.CMMT_ITEM_LONG);
                rfcTable_POACCOUNT_I.SetValue("FUNC_AREA_LONG", row.FUNC_AREA_LONG);
                rfcTable_POACCOUNT_I.SetValue("BUDGET_PERIOD", row.BUDGET_PERIOD);
                rfcTable_POACCOUNT_I.SetValue("FINAL_IND", row.FINAL_IND);
                rfcTable_POACCOUNT_I.SetValue("FINAL_REASON", row.FINAL_REASON);
            }
            rfcFunction.SetValue("POACCOUNT", rfcTable_POACCOUNT_I);
            IRfcTable rfcTable_POACCOUNTX_I = rfcFunction.GetTable("POACCOUNTX");
            foreach (BAPI_PO_CREATE1_POACCOUNTX row in import.POACCOUNTX)
            {
                rfcTable_POACCOUNTX_I.Append();
                BAPI_PO_CREATE1_POACCOUNTX datoTabla = new BAPI_PO_CREATE1_POACCOUNTX();
                rfcTable_POACCOUNTX_I.SetValue("PO_ITEM", row.PO_ITEM);
                rfcTable_POACCOUNTX_I.SetValue("SERIAL_NO", row.SERIAL_NO);
                rfcTable_POACCOUNTX_I.SetValue("PO_ITEMX", row.PO_ITEMX);
                rfcTable_POACCOUNTX_I.SetValue("SERIAL_NOX", row.SERIAL_NOX);
                rfcTable_POACCOUNTX_I.SetValue("DELETE_IND", row.DELETE_IND);
                rfcTable_POACCOUNTX_I.SetValue("CREAT_DATE", row.CREAT_DATE);
                rfcTable_POACCOUNTX_I.SetValue("QUANTITY", row.QUANTITY);
                rfcTable_POACCOUNTX_I.SetValue("DISTR_PERC", row.DISTR_PERC);
                rfcTable_POACCOUNTX_I.SetValue("NET_VALUE", row.NET_VALUE);
                rfcTable_POACCOUNTX_I.SetValue("GL_ACCOUNT", row.GL_ACCOUNT);
                rfcTable_POACCOUNTX_I.SetValue("BUS_AREA", row.BUS_AREA);
                rfcTable_POACCOUNTX_I.SetValue("COSTCENTER", row.COSTCENTER);
                rfcTable_POACCOUNTX_I.SetValue("SD_DOC", row.SD_DOC);
                rfcTable_POACCOUNTX_I.SetValue("ITM_NUMBER", row.ITM_NUMBER);
                rfcTable_POACCOUNTX_I.SetValue("SCHED_LINE", row.SCHED_LINE);
                rfcTable_POACCOUNTX_I.SetValue("ASSET_NO", row.ASSET_NO);
                rfcTable_POACCOUNTX_I.SetValue("SUB_NUMBER", row.SUB_NUMBER);
                rfcTable_POACCOUNTX_I.SetValue("ORDERID", row.ORDERID);
                rfcTable_POACCOUNTX_I.SetValue("GR_RCPT", row.GR_RCPT);
                rfcTable_POACCOUNTX_I.SetValue("UNLOAD_PT", row.UNLOAD_PT);
                rfcTable_POACCOUNTX_I.SetValue("CO_AREA", row.CO_AREA);
                rfcTable_POACCOUNTX_I.SetValue("COSTOBJECT", row.COSTOBJECT);
                rfcTable_POACCOUNTX_I.SetValue("PROFIT_CTR", row.PROFIT_CTR);
                rfcTable_POACCOUNTX_I.SetValue("WBS_ELEMENT", row.WBS_ELEMENT);
                rfcTable_POACCOUNTX_I.SetValue("NETWORK", row.NETWORK);
                rfcTable_POACCOUNTX_I.SetValue("RL_EST_KEY", row.RL_EST_KEY);
                rfcTable_POACCOUNTX_I.SetValue("PART_ACCT", row.PART_ACCT);
                rfcTable_POACCOUNTX_I.SetValue("CMMT_ITEM", row.CMMT_ITEM);
                rfcTable_POACCOUNTX_I.SetValue("REC_IND", row.REC_IND);
                rfcTable_POACCOUNTX_I.SetValue("FUNDS_CTR", row.FUNDS_CTR);
                rfcTable_POACCOUNTX_I.SetValue("FUND", row.FUND);
                rfcTable_POACCOUNTX_I.SetValue("FUNC_AREA", row.FUNC_AREA);
                rfcTable_POACCOUNTX_I.SetValue("REF_DATE", row.REF_DATE);
                rfcTable_POACCOUNTX_I.SetValue("TAX_CODE", row.TAX_CODE);
                rfcTable_POACCOUNTX_I.SetValue("TAXJURCODE", row.TAXJURCODE);
                rfcTable_POACCOUNTX_I.SetValue("NOND_ITAX", row.NOND_ITAX);
                rfcTable_POACCOUNTX_I.SetValue("ACTTYPE", row.ACTTYPE);
                rfcTable_POACCOUNTX_I.SetValue("CO_BUSPROC", row.CO_BUSPROC);
                rfcTable_POACCOUNTX_I.SetValue("RES_DOC", row.RES_DOC);
                rfcTable_POACCOUNTX_I.SetValue("RES_ITEM", row.RES_ITEM);
                rfcTable_POACCOUNTX_I.SetValue("ACTIVITY", row.ACTIVITY);
                rfcTable_POACCOUNTX_I.SetValue("GRANT_NBR", row.GRANT_NBR);
                rfcTable_POACCOUNTX_I.SetValue("BUDGET_PERIOD", row.BUDGET_PERIOD);
                rfcTable_POACCOUNTX_I.SetValue("FINAL_IND", row.FINAL_IND);
                rfcTable_POACCOUNTX_I.SetValue("FINAL_REASON", row.FINAL_REASON);
            }
            rfcFunction.SetValue("POACCOUNTX", rfcTable_POACCOUNTX_I);
            IRfcTable rfcTable_POITEM_I = rfcFunction.GetTable("POITEM");
            foreach (BAPI_PO_CREATE1_POITEM row in import.POITEM)
            {
                rfcTable_POITEM_I.Append();
                BAPI_PO_CREATE1_POITEM datoTabla = new BAPI_PO_CREATE1_POITEM();
                ...
                rfcTable_POITEM_I.SetValue("QUANTITY", Math.Round(row.QUANTITY, 2));
            ...
            foreach (BAPI_PO_CREATE1_POITEMX row in import.POITEMX)
            {
                rfcTable_POITEMX_I.Append();
                BAPI_PO_CREATE1_POITEMX datoTabla = new BAPI_PO_CREATE1_POITEMX();
            ...
            responce_BAPI_PO_CREATE1 res = new responce_BAPI_PO_CREATE1();
            res.EXPPURCHASEORDER = rfcFunction.GetString("EXPPURCHASEORDER");
            IRfcTable rfcTable_ALLVERSIONS = rfcFunction.GetTable("ALLVERSIONS");
            res.ALLVERSIONS = new BAPI_PO_CREATE1_ALLVERSIONS[rfcTable_ALLVERSIONS.RowCount];
            int i_ALLVERSIONS = 0;
            foreach (IRfcStructure row in rfcTable_ALLVERSIONS)
            {
                BAPI_PO_CREATE1_ALLVERSIONS datoTabla = new BAPI_PO_CREATE1_ALLVERSIONS();
            ...
            res.EXTENSIONIN = new BAPI_PO_CREATE1_EXTENSIONIN[rfcTable_EXTENSIONIN.RowCount];
            int i_EXTENSIONIN = 0;
            foreach (IRfcStructure row in rfcTable_EXTENSIONIN)
            {
                BAPI_PO_CREATE1_EXTENSIONIN datoTabla = new BAPI_PO_CREATE1_EXTENSIONIN();
            ...
            res.EXTENSIONOUT = new BAPI_PO_CREATE1_EXTENSIONOUT[rfcTable_EXTENSIONOUT.RowCount];
            int i_EXTENSIONOUT = 0;
            foreach (IRfcStructure row in rfcTable_EXTENSIONOUT)
            {
                BAPI_PO_CREATE1_EXTENSIONOUT datoTabla = new BAPI_PO_CREATE1_EXTENSIONOUT();
                datoTabla.STRUCTURE = row.GetString("STRUCTURE");
                datoTabla.VALUEPART1 = row.GetString("VALUEPART1");
                datoTabla.VALUEPART2 = row.GetString("VALUEPART2");
                datoTabla.VALUEPART3 = row.GetString("VALUEPART3");
            ...
            res.INVPLANHEADER = new BAPI_PO_CREATE1_INVPLANHEADER[rfcTable_INVPLANHEADER.RowCount];
            int i_INVPLANHEADER = 0;
            foreach (IRfcStructure row in rfcTable_INVPLANHEADER)
            {
                BAPI_PO_CREATE1_INVPLANHEADER datoTabla = new BAPI_PO_CREATE1_INVPLANHEADER();
            ...
            res.INVPLANHEADERX = new BAPI_PO_CREATE1_INVPLANHEADERX[rfcTable_INVPLANHEADERX.RowCount];
            int i_INVPLANHEADERX = 0;
            foreach (IRfcStructure row in rfcTable_INVPLANHEADERX)
            {
                BAPI_PO_CREATE1_INVPLANHEADERX datoTabla = new BAPI_PO_CREATE1_INVPLANHEADERX();
                datoTabla.DOC_ITEM = row.GetInt("DOC_ITEM");
                datoTabla.IV_PLAN_NUM = row.GetString("IV_PLAN_NUM");
                datoTabla.CATEGORY = row.GetString("CATEGORY");
                datoTabla.IP_TYPE = row.GetString("IP_TYPE");
            ...
            res.INVPLANITEM = new BAPI_PO_CREATE1_INVPLANITEM[rfcTable_INVPLANITEM.RowCount];
            int i_INVPLANITEM = 0;
            foreach (IRfcStructure row in rfcTable_INVPLANITEM)
            {
                BAPI_PO_CREATE1_INVPLANITEM datoTabla = new BAPI_PO_CREATE1_INVPLANITEM();
                datoTabla.DOC_ITEM = row.GetInt("DOC_ITEM");
                datoTabla.IV_PLAN_NUM = row.GetString("IV_PLAN_NUM");
            ...
            res.INVPLANITEMX = new BAPI_PO_CREATE1_INVPLANITEMX[rfcTable_INVPLANITEMX.RowCount];
            int i_INVPLANITEMX = 0;
            foreach (IRfcStructure row in rfcTable_INVPLANITEMX)
            {
                BAPI_PO_CREATE1_INVPLANITEMX datoTabla = new BAPI_PO_CREATE1_INVPLANITEMX();
                datoTabla.DOC_ITEM = row.GetInt("DOC_ITEM");
                datoTabla.IV_PLAN_NUM = row.GetString("IV_PLAN_NUM");
                datoTabla.IV_PLAN_ITEM = row.GetInt("IV_PLAN_ITEM");
                datoTabla.DEL_IND = row.GetString("DEL_IND");
            ...
            res.NFMETALLITMS = new BAPI_PO_CREATE1_NFMETALLITMS[rfcTable_NFMETALLITMS.RowCount];
            int i_NFMETALLITMS = 0;
            foreach (IRfcStructure row in rfcTable_NFMETALLITMS)
            {
                BAPI_PO_CREATE1_NFMETALLITMS datoTabla = new BAPI_PO_CREATE1_NFMETALLITMS();
            ...
            res.POACCOUNT = new BAPI_PO_CREATE1_POACCOUNT[rfcTable_POACCOUNT.RowCount];
            int i_POACCOUNT = 0;
            ...
            res.POACCOUNTPROFITSEGMENT = new BAPI_PO_CREATE1_POACCOUNTPROFITSEGMENT[rfcTable_POACCOUNTPROFITSEGMENT.RowCount];
            int i_POACCOUNTPROFITSEGMENT = 0;
            foreach (IRfcStructure row in rfcTable_POACCOUNTPROFITSEGMENT)
            {
                BAPI_PO_CREATE1_POACCOUNTPROFITSEGMENT datoTabla = new BAPI_PO_CREATE1_POACCOUNTPROFITSEGMENT();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SERIAL_NO = row.GetInt("SERIAL_NO");
            ...
            res.POACCOUNTX = new BAPI_PO_CREATE1_POACCOUNTX[rfcTable_POACCOUNTX.RowCount];
            int i_POACCOUNTX = 0;
            ...
            res.POADDRDELIVERY = new BAPI_PO_CREATE1_POADDRDELIVERY[rfcTable_POADDRDELIVERY.RowCount];
            int i_POADDRDELIVERY = 0;
            foreach (IRfcStructure row in rfcTable_POADDRDELIVERY)
            {
                BAPI_PO_CREATE1_POADDRDELIVERY datoTabla = new BAPI_PO_CREATE1_POADDRDELIVERY();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
            ...
            res.POCOMPONENTS = new BAPI_PO_CREATE1_POCOMPONENTS[rfcTable_POCOMPONENTS.RowCount];
            int i_POCOMPONENTS = 0;
            foreach (IRfcStructure row in rfcTable_POCOMPONENTS)
            {
                BAPI_PO_CREATE1_POCOMPONENTS datoTabla = new BAPI_PO_CREATE1_POCOMPONENTS();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
            ...
            res.POCOMPONENTSX = new BAPI_PO_CREATE1_POCOMPONENTSX[rfcTable_POCOMPONENTSX.RowCount];
            int i_POCOMPONENTSX = 0;
            foreach (IRfcStructure row in rfcTable_POCOMPONENTSX)
            {
                BAPI_PO_CREATE1_POCOMPONENTSX datoTabla = new BAPI_PO_CREATE1_POCOMPONENTSX();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
                datoTabla.ITEM_NO = row.GetInt("ITEM_NO");
                datoTabla.PO_ITEMX = row.GetString("PO_ITEMX");
            ...
            res.POCOND = new BAPI_PO_CREATE1_POCOND[rfcTable_POCOND.RowCount];
            int i_POCOND = 0;
            foreach (IRfcStructure row in rfcTable_POCOND)
            {
                BAPI_PO_CREATE1_POCOND datoTabla = new BAPI_PO_CREATE1_POCOND();
            ...
            res.POCONDHEADER = new BAPI_PO_CREATE1_POCONDHEADER[rfcTable_POCONDHEADER.RowCount];
            int i_POCONDHEADER = 0;
            foreach (IRfcStructure row in rfcTable_POCONDHEADER)
            {
                BAPI_PO_CREATE1_POCONDHEADER datoTabla = new BAPI_PO_CREATE1_POCONDHEADER();
                datoTabla.CONDITION_NO = row.GetString("CONDITION_NO");
                datoTabla.ITM_NUMBER = row.GetInt("ITM_NUMBER");
                datoTabla.COND_ST_NO = row.GetInt("COND_ST_NO");
                datoTabla.COND_COUNT = row.GetInt("COND_COUNT");
            ...
            res.POCONDHEADERX = new BAPI_PO_CREATE1_POCONDHEADERX[rfcTable_POCONDHEADERX.RowCount];
            int i_POCONDHEADERX = 0;
            foreach (IRfcStructure row in rfcTable_POCONDHEADERX)
            {
                BAPI_PO_CREATE1_POCONDHEADERX datoTabla = new BAPI_PO_CREATE1_POCONDHEADERX();
                datoTabla.CONDITION_NO = row.GetString("CONDITION_NO");
                datoTabla.ITM_NUMBER = row.GetInt("ITM_NUMBER");
                datoTabla.COND_ST_NO = row.GetInt("COND_ST_NO");
            ...
            res.POCONDX = new BAPI_PO_CREATE1_POCONDX[rfcTable_POCONDX.RowCount];
            int i_POCONDX = 0;
            foreach (IRfcStructure row in rfcTable_POCONDX)
            {
                BAPI_PO_CREATE1_POCONDX datoTabla = new BAPI_PO_CREATE1_POCONDX();
                datoTabla.CONDITION_NO = row.GetString("CONDITION_NO");
                datoTabla.ITM_NUMBER = row.GetInt("ITM_NUMBER");
                datoTabla.COND_ST_NO = row.GetInt("COND_ST_NO");
                datoTabla.CONDITION_NOX = row.GetString("CONDITION_NOX");
            ...
            res.POCONTRACTLIMITS = new BAPI_PO_CREATE1_POCONTRACTLIMITS[rfcTable_POCONTRACTLIMITS.RowCount];
            int i_POCONTRACTLIMITS = 0;
            foreach (IRfcStructure row in rfcTable_POCONTRACTLIMITS)
            {
                BAPI_PO_CREATE1_POCONTRACTLIMITS datoTabla = new BAPI_PO_CREATE1_POCONTRACTLIMITS();
            ...
            res.POEXPIMPITEM = new BAPI_PO_CREATE1_POEXPIMPITEM[rfcTable_POEXPIMPITEM.RowCount];
            int i_POEXPIMPITEM = 0;
            foreach (IRfcStructure row in rfcTable_POEXPIMPITEM)
            {
                BAPI_PO_CREATE1_POEXPIMPITEM datoTabla = new BAPI_PO_CREATE1_POEXPIMPITEM();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
            ...
            res.POEXPIMPITEMX = new BAPI_PO_CREATE1_POEXPIMPITEMX[rfcTable_POEXPIMPITEMX.RowCount];
            int i_POEXPIMPITEMX = 0;
            foreach (IRfcStructure row in rfcTable_POEXPIMPITEMX)
            {
                BAPI_PO_CREATE1_POEXPIMPITEMX datoTabla = new BAPI_PO_CREATE1_POEXPIMPITEMX();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.BUSINESS_TRANSACTION_TYPE = row.GetString("BUSINESS_TRANSACTION_TYPE");
                datoTabla.EXPORT_IMPORT_PROCEDURE = row.GetString("EXPORT_IMPORT_PROCEDURE");
                datoTabla.COUNTRYORI = row.GetString("COUNTRYORI");
            ...
            res.POITEM = new BAPI_PO_CREATE1_POITEM[rfcTable_POITEM.RowCount];
            int i_POITEM = 0;
            ...
            res.POITEMX = new BAPI_PO_CREATE1_POITEMX[rfcTable_POITEMX.RowCount];
            int i_POITEMX = 0;
            ...
            res.POLIMITS = new BAPI_PO_CREATE1_POLIMITS[rfcTable_POLIMITS.RowCount];
            int i_POLIMITS = 0;
            foreach (IRfcStructure row in rfcTable_POLIMITS)
            {
                BAPI_PO_CREATE1_POLIMITS datoTabla = new BAPI_PO_CREATE1_POLIMITS();
                datoTabla.PCKG_NO = row.GetInt("PCKG_NO");
                datoTabla.LIMIT = row.GetDecimal("LIMIT");
                datoTabla.NO_LIMIT = row.GetString("NO_LIMIT");
            ...
            res.POPARTNER = new BAPI_PO_CREATE1_POPARTNER[rfcTable_POPARTNER.RowCount];
            int i_POPARTNER = 0;
            foreach (IRfcStructure row in rfcTable_POPARTNER)
            {
                BAPI_PO_CREATE1_POPARTNER datoTabla = new BAPI_PO_CREATE1_POPARTNER();
            ...
            res.POSCHEDULE = new BAPI_PO_CREATE1_POSCHEDULE[rfcTable_POSCHEDULE.RowCount];
            int i_POSCHEDULE = 0;
            foreach (IRfcStructure row in rfcTable_POSCHEDULE)
            {
                BAPI_PO_CREATE1_POSCHEDULE datoTabla = new BAPI_PO_CREATE1_POSCHEDULE();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
            ...
            res.POSCHEDULEX = new BAPI_PO_CREATE1_POSCHEDULEX[rfcTable_POSCHEDULEX.RowCount];
            int i_POSCHEDULEX = 0;
            foreach (IRfcStructure row in rfcTable_POSCHEDULEX)
            {
                BAPI_PO_CREATE1_POSCHEDULEX datoTabla = new BAPI_PO_CREATE1_POSCHEDULEX();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
                datoTabla.PO_ITEMX = row.GetString("PO_ITEMX");
                datoTabla.SCHED_LINEX = row.GetString("SCHED_LINEX");
            ...
            res.POSERVICES = new BAPI_PO_CREATE1_POSERVICES[rfcTable_POSERVICES.RowCount];
            int i_POSERVICES = 0;
            foreach (IRfcStructure row in rfcTable_POSERVICES)
            {
                BAPI_PO_CREATE1_POSERVICES datoTabla = new BAPI_PO_CREATE1_POSERVICES();
                datoTabla.PCKG_NO = row.GetInt("PCKG_NO");
                datoTabla.LINE_NO = row.GetInt("LINE_NO");
            ...
            res.POSERVICESTEXT = new BAPI_PO_CREATE1_POSERVICESTEXT[rfcTable_POSERVICESTEXT.RowCount];
            int i_POSERVICESTEXT = 0;
            foreach (IRfcStructure row in rfcTable_POSERVICESTEXT)
            {
                BAPI_PO_CREATE1_POSERVICESTEXT datoTabla = new BAPI_PO_CREATE1_POSERVICESTEXT();
                datoTabla.PCKG_NO = row.GetInt("PCKG_NO");
                datoTabla.LINE_NO = row.GetInt("LINE_NO");
            ...
            res.POSHIPPING = new BAPI_PO_CREATE1_POSHIPPING[rfcTable_POSHIPPING.RowCount];
            int i_POSHIPPING = 0;
            foreach (IRfcStructure row in rfcTable_POSHIPPING)
            {
                BAPI_PO_CREATE1_POSHIPPING datoTabla = new BAPI_PO_CREATE1_POSHIPPING();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
            ...
            res.POSHIPPINGEXP = new BAPI_PO_CREATE1_POSHIPPINGEXP[rfcTable_POSHIPPINGEXP.RowCount];
            int i_POSHIPPINGEXP = 0;
            foreach (IRfcStructure row in rfcTable_POSHIPPINGEXP)
            {
                BAPI_PO_CREATE1_POSHIPPINGEXP datoTabla = new BAPI_PO_CREATE1_POSHIPPINGEXP();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SHIP_POINT = row.GetString("SHIP_POINT");
                datoTabla.DLV_PRIO = row.GetInt("DLV_PRIO");
                datoTabla.ROUTE = row.GetString("ROUTE");
            ...
            res.POSHIPPINGX = new BAPI_PO_CREATE1_POSHIPPINGX[rfcTable_POSHIPPINGX.RowCount];
            int i_POSHIPPINGX = 0;
            foreach (IRfcStructure row in rfcTable_POSHIPPINGX)
            {
                BAPI_PO_CREATE1_POSHIPPINGX datoTabla = new BAPI_PO_CREATE1_POSHIPPINGX();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.PO_ITEMX = row.GetString("PO_ITEMX");
                datoTabla.SHIP_POINT = row.GetString("SHIP_POINT");
                datoTabla.SHIP_COND = row.GetString("SHIP_COND");
            ...
            res.POSRVACCESSVALUES = new BAPI_PO_CREATE1_POSRVACCESSVALUES[rfcTable_POSRVACCESSVALUES.RowCount];
            int i_POSRVACCESSVALUES = 0;
            foreach (IRfcStructure row in rfcTable_POSRVACCESSVALUES)
            {
                BAPI_PO_CREATE1_POSRVACCESSVALUES datoTabla = new BAPI_PO_CREATE1_POSRVACCESSVALUES();
                datoTabla.PCKG_NO = row.GetInt("PCKG_NO");
                datoTabla.LINE_NO = row.GetInt("LINE_NO");
            ...
            res.POTEXTHEADER = new BAPI_PO_CREATE1_POTEXTHEADER[rfcTable_POTEXTHEADER.RowCount];
            int i_POTEXTHEADER = 0;
            foreach (IRfcStructure row in rfcTable_POTEXTHEADER)
            {
                BAPI_PO_CREATE1_POTEXTHEADER datoTabla = new BAPI_PO_CREATE1_POTEXTHEADER();
                datoTabla.PO_NUMBER = row.GetString("PO_NUMBER");
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.TEXT_ID = row.GetString("TEXT_ID");
            ...
            res.POTEXTITEM = new BAPI_PO_CREATE1_POTEXTITEM[rfcTable_POTEXTITEM.RowCount];
            int i_POTEXTITEM = 0;
            foreach (IRfcStructure row in rfcTable_POTEXTITEM)
            {
                BAPI_PO_CREATE1_POTEXTITEM datoTabla = new BAPI_PO_CREATE1_POTEXTITEM();
                datoTabla.PO_NUMBER = row.GetString("PO_NUMBER");
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.TEXT_ID = row.GetString("TEXT_ID");
                datoTabla.TEXT_FORM = row.GetString("TEXT_FORM");
            ...
            res.RETURN = new BAPI_PO_CREATE1_RETURN[rfcTable_RETURN.RowCount];
            int i_RETURN = 0;
            foreach (IRfcStructure row in rfcTable_RETURN)
            {
                BAPI_PO_CREATE1_RETURN datoTabla = new BAPI_PO_CREATE1_RETURN();
            ...
            res.SERIALNUMBER = new BAPI_PO_CREATE1_SERIALNUMBER[rfcTable_SERIALNUMBER.RowCount];
            int i_SERIALNUMBER = 0;
            foreach (IRfcStructure row in rfcTable_SERIALNUMBER)
            {
                BAPI_PO_CREATE1_SERIALNUMBER datoTabla = new BAPI_PO_CREATE1_SERIALNUMBER();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
                datoTabla.DELETE_IND = row.GetString("DELETE_IND");
            ...
            res.SERIALNUMBERX = new BAPI_PO_CREATE1_SERIALNUMBERX[rfcTable_SERIALNUMBERX.RowCount];
            int i_SERIALNUMBERX = 0;
            foreach (IRfcStructure row in rfcTable_SERIALNUMBERX)
            {
                BAPI_PO_CREATE1_SERIALNUMBERX datoTabla = new BAPI_PO_CREATE1_SERIALNUMBERX();
                datoTabla.PO_ITEM = row.GetInt("PO_ITEM");
                datoTabla.SCHED_LINE = row.GetInt("SCHED_LINE");
                datoTabla.PO_ITEMX = row.GetString("PO_ITEMX");
                datoTabla.SCHED_LINEX = row.GetString("SCHED_LINEX");
    ...
    public class request_BAPI_PO_CREATE1
    {
        ...
        public BAPI_PO_CREATE1_POADDRVENDOR POADDRVENDOR;
        public BAPI_PO_CREATE1_POEXPIMPHEADER POEXPIMPHEADER;
        public BAPI_PO_CREATE1_POEXPIMPHEADERX POEXPIMPHEADERX;
        public BAPI_PO_CREATE1_POHEADER POHEADER;
        public BAPI_PO_CREATE1_POHEADERX POHEADERX;
        public String TESTRUN;
        public BAPI_PO_CREATE1_VERSIONS VERSIONS;
        public BAPI_PO_CREATE1_POACCOUNT[] POACCOUNT;
        public BAPI_PO_CREATE1_POACCOUNTX[] POACCOUNTX;
        public BAPI_PO_CREATE1_POITEM[] POITEM;
        public BAPI_PO_CREATE1_POITEMX[] POITEMX;
        public String USER;
        public String PASS;
    }
    public class responce_BAPI_PO_CREATE1
    {
        public String EXPPURCHASEORDER;
        public bool RESULTADO_BAPI = false;
        public BAPI_PO_CREATE1_ALLVERSIONS[] ALLVERSIONS;
        public BAPI_PO_CREATE1_EXTENSIONIN[] EXTENSIONIN;
        public BAPI_PO_CREATE1_EXTENSIONOUT[] EXTENSIONOUT;
        public BAPI_PO_CREATE1_INVPLANHEADER[] INVPLANHEADER;
        public BAPI_PO_CREATE1_INVPLANHEADERX[] INVPLANHEADERX;
        public BAPI_PO_CREATE1_INVPLANITEM[] INVPLANITEM;
        public BAPI_PO_CREATE1_INVPLANITEMX[] INVPLANITEMX;
        public BAPI_PO_CREATE1_NFMETALLITMS[] NFMETALLITMS;
        public BAPI_PO_CREATE1_POACCOUNT[] POACCOUNT;
        public BAPI_PO_CREATE1_POACCOUNTPROFITSEGMENT[] POACCOUNTPROFITSEGMENT;
        public BAPI_PO_CREATE1_POACCOUNTX[] POACCOUNTX;
        public BAPI_PO_CREATE1_POADDRDELIVERY[] POADDRDELIVERY;
        public BAPI_PO_CREATE1_POCOMPONENTS[] POCOMPONENTS;
        public BAPI_PO_CREATE1_POCOMPONENTSX[] POCOMPONENTSX;
        public BAPI_PO_CREATE1_POCOND[] POCOND;
        public BAPI_PO_CREATE1_POCONDHEADER[] POCONDHEADER;
        public BAPI_PO_CREATE1_POCONDHEADERX[] POCONDHEADERX;
        public BAPI_PO_CREATE1_POCONDX[] POCONDX;
        public BAPI_PO_CREATE1_POCONTRACTLIMITS[] POCONTRACTLIMITS;
        public BAPI_PO_CREATE1_POEXPIMPITEM[] POEXPIMPITEM;
        public BAPI_PO_CREATE1_POEXPIMPITEMX[] POEXPIMPITEMX;
        public BAPI_PO_CREATE1_POITEM[] POITEM;
        public BAPI_PO_CREATE1_POITEMX[] POITEMX;
        public BAPI_PO_CREATE1_POLIMITS[] POLIMITS;
        public BAPI_PO_CREATE1_POPARTNER[] POPARTNER;
        public BAPI_PO_CREATE1_POSCHEDULE[] POSCHEDULE;
        public BAPI_PO_CREATE1_POSCHEDULEX[] POSCHEDULEX;
        public BAPI_PO_CREATE1_POSERVICES[] POSERVICES;
        public BAPI_PO_CREATE1_POSERVICESTEXT[] POSERVICESTEXT;
        public BAPI_PO_CREATE1_POSHIPPING[] POSHIPPING;
        public BAPI_PO_CREATE1_POSHIPPINGEXP[] POSHIPPINGEXP;
        public BAPI_PO_CREATE1_POSHIPPINGX[] POSHIPPINGX;
        public BAPI_PO_CREATE1_POSRVACCESSVALUES[] POSRVACCESSVALUES;
        public BAPI_PO_CREATE1_POTEXTHEADER[] POTEXTHEADER;
        public BAPI_PO_CREATE1_POTEXTITEM[] POTEXTITEM;
        public BAPI_PO_CREATE1_RETURN[] RETURN;
        public BAPI_PO_CREATE1_SERIALNUMBER[] SERIALNUMBER;
        public BAPI_PO_CREATE1_SERIALNUMBERX[] SERIALNUMBERX;
    }
    public class BAPI_PO_CREATE1_POADDRVENDOR
    {
    ...
    public class BAPI_PO_CREATE1_POEXPIMPHEADER
    {
        public String TRANSPORT_MODE;
        public String CUSTOMS;
    }
    public class BAPI_PO_CREATE1_POEXPIMPHEADERX
    {
        public String TRANSPORT_MODE;
        public String CUSTOMS;
    }
    public class BAPI_PO_CREATE1_POHEADER
    {
        public String PO_NUMBER;
    ...
    public class BAPI_PO_CREATE1_POHEADERX
    {
        public String PO_NUMBER;
        public String COMP_CODE;
        public String DOC_TYPE;
    ...
    public class BAPI_PO_CREATE1_VERSIONS
    {
    ...
    public class BAPI_PO_CREATE1_ALLVERSIONS
    {
        public String DOC_TYPE;
    ...
    public class BAPI_PO_CREATE1_EXTENSIONIN
    {
    ...
    public class BAPI_PO_CREATE1_EXTENSIONOUT
    {
        public String STRUCTURE;
        public String VALUEPART1;
        public String VALUEPART2;
    ...
    public class BAPI_PO_CREATE1_INVPLANHEADER
    {
    ...
    public class BAPI_PO_CREATE1_INVPLANHEADERX
    {
        public Int32 DOC_ITEM;
        public String IV_PLAN_NUM;
        public String CATEGORY;
    ...
    public class BAPI_PO_CREATE1_INVPLANITEM
    {
        public Int32 DOC_ITEM;
        public String IV_PLAN_NUM;
    ...
    public class BAPI_PO_CREATE1_INVPLANITEMX
    {
        public Int32 DOC_ITEM;
        public String IV_PLAN_NUM;
        public Int32 IV_PLAN_ITEM;
    ...
    public class BAPI_PO_CREATE1_NFMETALLITMS
    {
    ...
    public class BAPI_PO_CREATE1_POACCOUNT
    {
    ...
    public class BAPI_PO_CREATE1_POACCOUNTPROFITSEGMENT
    {
        public Int32 PO_ITEM;
        public Int32 SERIAL_NO;
    ...
    public class BAPI_PO_CREATE1_POACCOUNTX
    {
        public Int32 PO_ITEM;
        public Int32 SERIAL_NO;
    ...
    public class BAPI_PO_CREATE1_POADDRDELIVERY
    {
        public Int32 PO_ITEM;
        public String ADDR_NO;
        public String FORMOFADDR;
    ...
    public class BAPI_PO_CREATE1_POCOMPONENTS
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
    ...
    public class BAPI_PO_CREATE1_POCOMPONENTSX
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
        public Int32 ITEM_NO;
    ...
    public class BAPI_PO_CREATE1_POCOND
    {
    ...
    public class BAPI_PO_CREATE1_POCONDHEADER
    {
        public String CONDITION_NO;
        public Int32 ITM_NUMBER;
        public Int32 COND_ST_NO;
    ...
    public class BAPI_PO_CREATE1_POCONDHEADERX
    {
        public String CONDITION_NO;
        public Int32 ITM_NUMBER;
        public Int32 COND_ST_NO;
    ...
    public class BAPI_PO_CREATE1_POCONDX
    {
        public String CONDITION_NO;
        public Int32 ITM_NUMBER;
        public Int32 COND_ST_NO;
    ...
    public class BAPI_PO_CREATE1_POCONTRACTLIMITS
    {
    ...
    public class BAPI_PO_CREATE1_POEXPIMPITEM
    {
        public Int32 PO_ITEM;
    ...
    public class BAPI_PO_CREATE1_POEXPIMPITEMX
    {
        public Int32 PO_ITEM;
        public String BUSINESS_TRANSACTION_TYPE;
        public String EXPORT_IMPORT_PROCEDURE;
    ...
    public class BAPI_PO_CREATE1_POITEM
    {
        public Int32 PO_ITEM;
        public String DELETE_IND;
        public String SHORT_TEXT;
    ...
    public class BAPI_PO_CREATE1_POITEMX
    {
        public Int32 PO_ITEM;
        public String PO_ITEMX;
        public String DELETE_IND;
    ...
    public class BAPI_PO_CREATE1_POLIMITS
    {
        public Int32 PCKG_NO;
        public Decimal LIMIT;
        public String NO_LIMIT;
    ...
    public class BAPI_PO_CREATE1_POPARTNER
    {
    ...
    public class BAPI_PO_CREATE1_POSCHEDULE
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
    ...
    public class BAPI_PO_CREATE1_POSCHEDULEX
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
        public String PO_ITEMX;
    ...
    public class BAPI_PO_CREATE1_POSERVICES
    {
        public Int32 PCKG_NO;
        public Int32 LINE_NO;
    ...
    public class BAPI_PO_CREATE1_POSERVICESTEXT
    {
        public Int32 PCKG_NO;
        public Int32 LINE_NO;
    ...
    public class BAPI_PO_CREATE1_POSHIPPING
    {
        public Int32 PO_ITEM;
    ...
    public class BAPI_PO_CREATE1_POSHIPPINGEXP
    {
        public Int32 PO_ITEM;
        public String SHIP_POINT;
        public Int32 DLV_PRIO;
    ...
    public class BAPI_PO_CREATE1_POSHIPPINGX
    {
        public Int32 PO_ITEM;
        public String PO_ITEMX;
        public String SHIP_POINT;
    ...
    public class BAPI_PO_CREATE1_POSRVACCESSVALUES
    {
        public Int32 PCKG_NO;
        public Int32 LINE_NO;
    ...
    public class BAPI_PO_CREATE1_POTEXTHEADER
    {
        public String PO_NUMBER;
        public Int32 PO_ITEM;
        public String TEXT_ID;
    ...
    public class BAPI_PO_CREATE1_POTEXTITEM
    {
        public String PO_NUMBER;
        public Int32 PO_ITEM;
        public String TEXT_ID;
    ...
    public class BAPI_PO_CREATE1_RETURN
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class BAPI_PO_CREATE1_SERIALNUMBER
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
        public String DELETE_IND;
    ...
    public class BAPI_PO_CREATE1_SERIALNUMBERX
    {
        public Int32 PO_ITEM;
        public Int32 SCHED_LINE;
        public String PO_ITEMX;

...
namespace rfcBaika
{
    public partial class ECO_CONSULTA_TIPOFRIO : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DB_ECO_CONSULTA_TIPOFRIO db = new DB_ECO_CONSULTA_TIPOFRIO();
            request_ECO_CONSULTA_TIPOFRIO req = new request_ECO_CONSULTA_TIPOFRIO();
            req.CENTRO = centro;

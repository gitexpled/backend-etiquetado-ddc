...
namespace rfcBaika
{
    public class ZMOV_CREATE_AGRUPALOTE_CAL
    {
        public responce_ZMOV_CREATE_AGRUPALOTE_CAL sapRun(request_ZMOV_CREATE_AGRUPALOTE_CAL import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("PRO_router");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_AGRUPALOTE_CAL");
            ...
            //01.SetValue("DOC_DATE", import.HEADER.DOC_DATE);
            ...
            foreach (ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS row in import.ITEMS)
            {
                rfcTable_ITEMS_I.Append();
                ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS datoTabla = new ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS();
            ...
            responce_ZMOV_CREATE_AGRUPALOTE_CAL res = new responce_ZMOV_CREATE_AGRUPALOTE_CAL();
            res.MATERIALDOCUMENT = rfcFunction.GetString("MATERIALDOCUMENT");
            IRfcTable rfcTable_ITEMS = rfcFunction.GetTable("ITEMS");
            res.ITEMS = new ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS[rfcTable_ITEMS.RowCount];
            int i_ITEMS = 0;
            ...
            res.RETURN = new ZMOV_CREATE_AGRUPALOTE_CAL_RETURN[rfcTable_RETURN.RowCount];
            int i_RETURN = 0;
            foreach (IRfcStructure row in rfcTable_RETURN)
            {
                ZMOV_CREATE_AGRUPALOTE_CAL_RETURN datoTabla = new ZMOV_CREATE_AGRUPALOTE_CAL_RETURN();
    ...
    public class request_ZMOV_CREATE_AGRUPALOTE_CAL
    {
        public ZMOV_CREATE_AGRUPALOTE_CAL_HEADER HEADER;
        public ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS[] ITEMS;
    }
    public class responce_ZMOV_CREATE_AGRUPALOTE_CAL
    {
        public String MATERIALDOCUMENT;
        public ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS[] ITEMS;
        public ZMOV_CREATE_AGRUPALOTE_CAL_RETURN[] RETURN;
    }
    public class ZMOV_CREATE_AGRUPALOTE_CAL_HEADER
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_CAL_ITEMS
    {
    ...
    public class ZMOV_CREATE_AGRUPALOTE_CAL_RETURN
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;

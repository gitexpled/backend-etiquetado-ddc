...
namespace rfcBaika
{
    public class DB_CARGA_INICIAL
    {
        public Array run(request_CARGA_INICIAL datos)
        {
            List<responce_CARGA_INICIAL> List = new List<responce_CARGA_INICIAL>();
            ...
            try
            {
                cmd = new SqlCommand("Carga_Inicial", connection);
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        responce_CARGA_INICIAL res = new responce_CARGA_INICIAL();
            ...
            catch (Exception e)
            {
                ...
                responce_CARGA_INICIAL resp = new responce_CARGA_INICIAL();
    ...
    public class responce_CARGA_INICIAL
    {
    ...
    public class request_CARGA_INICIAL
    {
        public String CENTRO;
        public String PROCESO;
    }

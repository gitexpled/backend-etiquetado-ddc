...
namespace rfcBaika
{
    public class DB_ECO_INFORME_ENVASE
    {
        public Array run(request_ECO_INFORME_ENVASE datos)
        {
            List<responce_ECO_INFORME_ENVASE> List = new List<responce_ECO_INFORME_ENVASE>();
            ...
            sql += "      ,ISNULL((SE1.LUNES / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100)  ),0) AS 'LUNES1' ";
            sql += "       ,ISNULL((SE1.MARTES / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100) ),0) AS 'MARTES1' ";
            sql += "       ,ISNULL((SE1.MIERCOLES / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100)  ),0) AS 'MIERCOLES1' ";
            sql += "       ,ISNULL((SE1.JUEVES / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100)  ),0) AS 'JUEVES1' ";
            sql += "       ,ISNULL((SE1.VIERNES / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100) ),0) AS 'VIERNES1' ";
            sql += "      ,ISNULL((SE1.SABADO / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100)  ),0) AS 'SABADO1' ";
            sql += "      ,ISNULL((SE1.DOMINGO / ET.PESO * (TP.VALOR1 / 100) * (CB.VALOR1 / 100)  ),0) AS 'DOMINGO1' ";
            ...
            sql += "       ,ISNULL((SE2.LUNES / ET.PESO *  (TP.VALOR2 / 100) *(CB.VALOR2 / 100) ),0) AS 'LUNES2' ";
            sql += "       ,ISNULL((SE2.MARTES / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'MARTES2' ";
            sql += "       ,ISNULL((SE2.MIERCOLES / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'MIERCOLES2' ";
            sql += "       ,ISNULL((SE2.JUEVES / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'JUEVES2' ";
            sql += "       ,ISNULL((SE2.VIERNES / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'VIERNES2' ";
            sql += "      ,ISNULL((SE2.SABADO / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'SABADO2' ";
            sql += "       ,ISNULL((SE2.DOMINGO / ET.PESO * (TP.VALOR2 / 100) * (CB.VALOR2 / 100)  ),0) AS 'DOMINGO2' ";
            ...
            sql += "      , (ea.S" + sm4 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100) ) 'TOTAL3' ";
            sql += "       , (ea.S" + sm5 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100) )'TOTAL4' ";
            sql += "       , (ea.S" + sm6 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) 'TOTAL5' ";
            sql += "       , (ea.S" + sm7 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) 'TOTAL6' ";
            /*sql += "      ,(ea.S" + sm1 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA1'        ,";
            sql += "       (ea.S" + sm2 + " / ET.PESO *  (TP.VALOR / 100) *(CB.VALOR / 100) ) AS 'TOTALA2'       ,";
            sql += "       (ea.S" + sm3 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA3'        ,";
            sql += "       (ea.S" + sm4 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA4'        ,";
            sql += "       (ea.S" + sm5 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA5'        ,";
            sql += "       (ea.S" + sm6 + " / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA6'        ";*/
            //agregado por im para los datos que no tengas distribuciòn semanal
            /*sql += "       ,(SEA1.TOTAL / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA1' ";
            sql += "       ,(SEA2.TOTAL / ET.PESO *  (TP.VALOR / 100) *(CB.VALOR / 100) ) AS 'TOTALA2' ";
            sql += "       ,(SEA3.TOTAL / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA3' ";
            sql += "       ,(SEA4.TOTAL / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA4' ";
            sql += "       ,(SEA5.TOTAL / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA5' ";
            sql += "       ,(SEA6.TOTAL / ET.PESO * (TP.VALOR / 100) * (CB.VALOR / 100)  ) AS 'TOTALA6' ";*/
            // fin im
            ...
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm2 + " AND editado in (" + sm1 + ") )SE1 ON SE1.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm3 + " AND editado in (" + sm1 + ")) SE2 ON SE2.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm4 + " AND editado in (" + sm1 + ")) SE3 ON SE3.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm5 + " AND editado in (" + sm1 + ")) SE4 ON SE4.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm6 + " AND editado in (" + sm1 + ")) SE5 ON SE5.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm7 + " AND editado in (" + sm1 + ")) SE6 ON SE6.id_anual = EA.id ";
            ...
            //sql += " and etp2.estimacion = 2 and etp2.anual = 0 and etp2.editado = " + sm1;
                //agregado por im para los datos que no tengas distribuciòn semanal
           /* sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm2 + "  AND editado in (0)) SEA1 ON SEA1.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm3 + "  AND editado in (0)) SEA2 ON SEA2.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm4 + "  AND editado in (0)) SEA3 ON SEA3.id_anual = EA.id ";  
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm5 + "  AND editado in (0)) SEA4 ON SEA4.id_anual = EA.id ";  
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm6 + "  AND editado in (0)) SEA5 ON SEA5.id_anual = EA.id ";
            sql += "   left JOIN (SELECT * FROM eco_detalle_dia WHERE semana = " + sm7 + "  AND editado in (0)) SEA6 ON SEA6.id_anual = EA.id "; */
            // fin im
            ...
            if (dataReader.HasRows)
            {
                ...
                {
                    responce_ECO_INFORME_ENVASE res = new responce_ECO_INFORME_ENVASE();
                    ...
                    res.LUNE1 = dataReader[8].ToString();
                    ...
                    res.LUNE2 = dataReader[16].ToString();
    ...
    public class responce_ECO_INFORME_ENVASE
    {
    ...
    public class request_ECO_INFORME_ENVASE
    {

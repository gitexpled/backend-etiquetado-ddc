...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_FRESCO_UAT
    {
        public responce_ZMOV_CREATE_RECEP_FRESCO_UAT sapRun(request_ZMOV_CREATE_RECEP_FRESCO_UAT import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_FRESCO_UAT");
            ...
            //rfcFunction.SetValue("IR_CLASSNUM", import.IR_CLASSNUM);
            IRfcTable rfcTable_IR_CLASSNUM_I = rfcFunction.GetTable("IR_CLASSNUM");
            foreach (ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM row in import.IR_CLASSNUM)
            {
                rfcTable_IR_CLASSNUM_I.Append();
                ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM();
                rfcTable_IR_CLASSNUM_I.SetValue("SIGN", row.SIGN);
                rfcTable_IR_CLASSNUM_I.SetValue("OPTION", row.OPTION);
                rfcTable_IR_CLASSNUM_I.SetValue("LOW", row.LOW);
                rfcTable_IR_CLASSNUM_I.SetValue("HIGH", row.HIGH);
            }
            rfcFunction.SetValue("IR_CLASSNUM", rfcTable_IR_CLASSNUM_I);
            IRfcTable rfcTable_LT_ITEMS_I = rfcFunction.GetTable("LT_ITEMS");
            foreach (ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEMS datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEMS();
            ...
            foreach (ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEM_DEST row in import.LT_ITEM_DEST)
            {
                rfcTable_LT_ITEM_DEST_I.Append();
                ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEM_DEST datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEM_DEST();
            ...
            foreach (ZMOV_CREATE_RECEP_FRESCO_UAT_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_CREATE_RECEP_FRESCO_UAT_LT_CARACT datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_CARACT();
            ...
            rfcFunction.SetValue("I_RECEIVED_VARIETY", import.I_RECEIVED_VARIETY);
            rfcFunction.SetValue("I_UAT", import.I_UAT);
            rfcFunction.Invoke(configSap);
            string aa = rfcFunction.ToString();

            responce_ZMOV_CREATE_RECEP_FRESCO_UAT res = new responce_ZMOV_CREATE_RECEP_FRESCO_UAT();
            ...
            IRfcTable rfcTable_IR_CLASSNUM = rfcFunction.GetTable("IR_CLASSNUM");
            res.IR_CLASSNUM = new ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM[rfcTable_IR_CLASSNUM.RowCount];
            int i_IR_CLASSNUM = 0;
            foreach (IRfcStructure row in rfcTable_IR_CLASSNUM)
            {
                ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM();
                ...
                res.IR_CLASSNUM[i_IR_CLASSNUM] = datoTabla; ++i_IR_CLASSNUM;
            }
            IRfcTable rfcTable_LOG = rfcFunction.GetTable("LOG");
            res.LOG = new ZMOV_CREATE_RECEP_FRESCO_UAT_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            foreach (IRfcStructure row in rfcTable_LOG)
            {
                ZMOV_CREATE_RECEP_FRESCO_UAT_LOG datoTabla = new ZMOV_CREATE_RECEP_FRESCO_UAT_LOG();
            ...
            res.LT_CARACT = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
            ...
            res.LT_ITEM_DEST = new ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEM_DEST[rfcTable_LT_ITEM_DEST.RowCount];
    ...
    public class request_ZMOV_CREATE_RECEP_FRESCO_UAT
    {
        public ZMOV_CREATE_RECEP_FRESCO_UAT_HEADER HEADER;
        //public String IR_CLASSNUM;
    ...
    public class responce_ZMOV_CREATE_RECEP_FRESCO_UAT
    {
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_IR_CLASSNUM
    {
        public String SIGN;
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_LT_CARACT
    {
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEMS
    {
    ...
    public class ZMOV_CREATE_RECEP_FRESCO_UAT_LT_ITEM_DEST
    {
        public Int32 LFPOS;
        public String MATERIAL;
        public Decimal QUANTITY;

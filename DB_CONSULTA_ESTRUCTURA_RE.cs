...
namespace rfcBaika
{
    public class DB_CONSULTA_ESTRUCTURA_RE
    {
        public Array run(request_CONSULTA_ESTRUCTURA_RE datos)
        {
            List<responce_CONSULTA_ESTRUCTURA_RE> List = new List<responce_CONSULTA_ESTRUCTURA_RE>();
            String _connectionString = ConfigurationManager.ConnectionStrings["CS"].ToString();
            SqlConnection connection = new SqlConnection(_connectionString);
            connection.Open();
            String sql = "select * from posicion_re where centro = '" + datos.centro + "'";
            ...
            if (dataReader.HasRows)
            {
                ...
                {
                    responce_CONSULTA_ESTRUCTURA_RE res = new responce_CONSULTA_ESTRUCTURA_RE();
    ...
    public class responce_CONSULTA_ESTRUCTURA_RE
    {
        public String id;
    ...
    public class request_CONSULTA_ESTRUCTURA_RE
    {
        public String centro;
    }
}
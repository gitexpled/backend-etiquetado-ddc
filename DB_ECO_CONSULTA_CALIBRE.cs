...
namespace rfcBaika
{
    public class DB_ECO_CONSULTA_CALIBRE
    {
        public Array run(request_ECO_CONSULTA_CALIBRE datos)
        {
            List<responce_ECO_CONSULTA_CALIBRE> List = new List<responce_ECO_CONSULTA_CALIBRE>();
            ...
            sql += "FROM ECO_ANUAL EA left join eco_calibre ET  ON EA.Nombre = ET.estimacion  WHERE ET.usuario =" + datos.USUARIO;
            ...
            if (dataReader.HasRows)
            {
                ...
                {
                    responce_ECO_CONSULTA_CALIBRE res = new responce_ECO_CONSULTA_CALIBRE();
    ...
    public class responce_ECO_CONSULTA_CALIBRE
    {
    ...
    public class request_ECO_CONSULTA_CALIBRE
    {
        public String CENTRO;
        public String PRODUCTOR;
        public String ESPECIE;

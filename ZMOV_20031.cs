...
namespace rfcBaika
{
    public class ZMOV_20031
    {
        public responce_ZMOV_20031 sapRun(request_ZMOV_20031 import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_20031");
            ...
            foreach (ZMOV_20031_IR_MTART_NOT_541 row in import.IR_MTART_NOT_541)
            {
                rfcTable_IR_MTART_NOT_541_I.Append();
                ZMOV_20031_IR_MTART_NOT_541 datoTabla = new ZMOV_20031_IR_MTART_NOT_541();
            ...
            foreach (ZMOV_20031_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_20031_LT_CARACT datoTabla = new ZMOV_20031_LT_CARACT();
            ...
            foreach (ZMOV_20031_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_20031_LT_ITEMS datoTabla = new ZMOV_20031_LT_ITEMS();
            ...
            foreach (ZMOV_20031_LT_ITEM_DEST row in import.LT_ITEM_DEST)
            {
                rfcTable_LT_ITEM_DEST_I.Append();
                ZMOV_20031_LT_ITEM_DEST datoTabla = new ZMOV_20031_LT_ITEM_DEST();
            ...
            foreach (ZMOV_20031_LT_MATNR_PALLET row in import.LT_MATNR_PALLET)
            {
                rfcTable_LT_MATNR_PALLET_I.Append();
                ZMOV_20031_LT_MATNR_PALLET datoTabla = new ZMOV_20031_LT_MATNR_PALLET();
                rfcTable_LT_MATNR_PALLET_I.SetValue("MATNR", row.MATNR);
            }
            IRfcTable rfcTable_LOG_I = rfcFunction.GetTable("LOG");
            foreach (ZMOV_20031_LOG row in import.LOG)
            {
                rfcTable_LOG_I.Append();
                ZMOV_20031_LOG datoTabla = new ZMOV_20031_LOG();
            ...
            responce_ZMOV_20031 res = new responce_ZMOV_20031();
            ...
            res.IR_MTART_NOT_541 = new ZMOV_20031_IR_MTART_NOT_541[rfcTable_IR_MTART_NOT_541.RowCount];
            ...
            res.LOG = new ZMOV_20031_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            ...
            res.LT_LOG_MAT_STOCK = new ZMOV_20031_LT_LOG_MAT_STOCK[rfcTable_LT_LOG_MAT_STOCK.RowCount];
            int i_LT_LOG_MAT_STOCK = 0;
            foreach (IRfcStructure row in rfcTable_LT_LOG_MAT_STOCK)
            {
                ZMOV_20031_LT_LOG_MAT_STOCK datoTabla = new ZMOV_20031_LT_LOG_MAT_STOCK();
            ...
            res.LT_CARACT = new ZMOV_20031_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_20031_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
            ...
            res.LT_ITEM_DEST = new ZMOV_20031_LT_ITEM_DEST[rfcTable_LT_ITEM_DEST.RowCount];
            ...
            res.LT_MATNR_PALLET = new ZMOV_20031_LT_MATNR_PALLET[rfcTable_LT_MATNR_PALLET.RowCount];
    ...
    public class request_ZMOV_20031
    {
    ...
    public class responce_ZMOV_20031
    {
    ...
    public class ZMOV_20031_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_20031_HEADER_ADIC
    {
        public String STLAL;
        public String EXTWG;
    ...
    public class ZMOV_20031_HEADER_HU
    {
    ...
    public class ZMOV_20031_IR_MTART_NOT_541
    {
        public String SIGN;
    ...
    public class ZMOV_20031_LT_LOG_MAT_STOCK
    {
        public String MATNR;
    ...
    public class ZMOV_20031_LT_CARACT
    {
    ...
    public class ZMOV_20031_LT_ITEMS
    {
    ...
    public class ZMOV_20031_LT_ITEM_DEST
    {
        public Int32 LFPOS;
        public String MATERIAL;
        public Decimal QUANTITY;
    ...
    public class ZMOV_20031_LT_MATNR_PALLET
    {
        public String MATNR;
    }

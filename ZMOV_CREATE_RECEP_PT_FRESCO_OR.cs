...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR
    {
        public responce_ZMOV_CREATE_RECEP_PT_FRESCO_OR sapRun(request_ZMOV_CREATE_RECEP_PT_FRESCO_OR import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_PT_FRESCO_OR");
            ...
            RfcStructureMetadata obj_ZMOV_ST_HEADER_ADIC = SapRfcRepository.GetStructureMetadata("ZMOV_ST_HEADER_ADIC");
            IRfcStructure datos_ZMOV_ST_HEADER_ADIC = obj_ZMOV_ST_HEADER_ADIC.CreateStructure();
            datos_ZMOV_ST_HEADER_ADIC.SetValue("STLAL", import.HEADER_ADIC.STLAL);
            rfcFunction.SetValue("HEADER_ADIC", datos_ZMOV_ST_HEADER_ADIC);
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_OR_IR_MTART_NOT_541 row in import.IR_MTART_NOT_541)
            {
                rfcTable_IR_MTART_NOT_541_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_OR_IR_MTART_NOT_541 datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_IR_MTART_NOT_541();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_OR_LOG row in import.LOG)
            {
                rfcTable_LOG_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_OR_LOG datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LOG();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_CARACT datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_CARACT();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEMS datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEMS();
            ...
            foreach (ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEM_DEST row in import.LT_ITEM_DEST)
            {
                rfcTable_LT_ITEM_DEST_I.Append();
                ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEM_DEST datoTabla = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEM_DEST();
            ...
            responce_ZMOV_CREATE_RECEP_PT_FRESCO_OR res = new responce_ZMOV_CREATE_RECEP_PT_FRESCO_OR();
            ...
            res.IR_MTART_NOT_541 = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_IR_MTART_NOT_541[rfcTable_IR_MTART_NOT_541.RowCount];
            ...
            res.LOG = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            ...
            res.LT_CARACT = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
            ...
            res.LT_ITEM_DEST = new ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEM_DEST[rfcTable_LT_ITEM_DEST.RowCount];
    ...
    public class request_ZMOV_CREATE_RECEP_PT_FRESCO_OR
    {
    ...
    public class responce_ZMOV_CREATE_RECEP_PT_FRESCO_OR
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_HEADER_ADIC
    {
        public String STLAL;
    }
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_HEADER_HU
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_IR_MTART_NOT_541
    {
        public String SIGN;
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_CARACT
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEMS
    {
    ...
    public class ZMOV_CREATE_RECEP_PT_FRESCO_OR_LT_ITEM_DEST
    {
        public Int32 LFPOS;
        public String MATERIAL;
        public Decimal QUANTITY;

...
namespace rfcBaika
{
    public class ZMOV_CREATE_RECEP_HU_FRESCO
    {
        public responce_ZMOV_CREATE_RECEP_HU_FRESCO sapRun(request_ZMOV_CREATE_RECEP_HU_FRESCO import)
        {
            RfcDestination configSap = RfcDestinationManager.GetDestination("DDC");
            RfcRepository SapRfcRepository = configSap.Repository;
            IRfcFunction rfcFunction = SapRfcRepository.CreateFunction("ZMOV_CREATE_RECEP_HU_FRESCO");
            ...
            foreach (ZMOV_CREATE_RECEP_HU_FRESCO_LOG row in import.LOG)
            {
                rfcTable_LOG_I.Append();
                ZMOV_CREATE_RECEP_HU_FRESCO_LOG datoTabla = new ZMOV_CREATE_RECEP_HU_FRESCO_LOG();
            ...
            foreach (ZMOV_CREATE_RECEP_HU_FRESCO_LT_CARACT row in import.LT_CARACT)
            {
                rfcTable_LT_CARACT_I.Append();
                ZMOV_CREATE_RECEP_HU_FRESCO_LT_CARACT datoTabla = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_CARACT();
            ...
            foreach (ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEMS row in import.LT_ITEMS)
            {
                rfcTable_LT_ITEMS_I.Append();
                ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEMS datoTabla = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEMS();
            ...
            foreach (ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEM_DEST row in import.LT_ITEM_DEST)
            {
                rfcTable_LT_ITEM_DEST_I.Append();
                ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEM_DEST datoTabla = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEM_DEST();
            ...
            responce_ZMOV_CREATE_RECEP_HU_FRESCO res = new responce_ZMOV_CREATE_RECEP_HU_FRESCO();
            ...
            res.LOG = new ZMOV_CREATE_RECEP_HU_FRESCO_LOG[rfcTable_LOG.RowCount];
            int i_LOG = 0;
            ...
            res.LT_CARACT = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_CARACT[rfcTable_LT_CARACT.RowCount];
            int i_LT_CARACT = 0;
            ...
            res.LT_ITEMS = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEMS[rfcTable_LT_ITEMS.RowCount];
            int i_LT_ITEMS = 0;
            ...
            res.LT_ITEM_DEST = new ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEM_DEST[rfcTable_LT_ITEM_DEST.RowCount];
    ...
    public class request_ZMOV_CREATE_RECEP_HU_FRESCO
    {
    ...
    public class responce_ZMOV_CREATE_RECEP_HU_FRESCO
    {
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_HEADER
    {
        public String BUKRS;
        public String EKORG;
        public String EKGRP;
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_HEADER_HU
    {
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_LOG
    {
        public String TYPE;
        public String ID;
        public Int32 NUMBER;
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_LT_CARACT
    {
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEMS
    {
    ...
    public class ZMOV_CREATE_RECEP_HU_FRESCO_LT_ITEM_DEST
    {
        public Int32 LFPOS;
        public String MATERIAL;
        public Decimal QUANTITY;
